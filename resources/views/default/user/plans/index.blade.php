									...
									@role('user|subscriber|admin')
										@if (config('settings.image_feature_user') == 'allow')
											<div class="col-lg col-md-6 col-sm-6">
												...
												<h4 class="mb-3 font-weight-800 text-primary fs-20">@if(auth()->user()->image_credits == -1) {{ __('Unlimited') }} @else {{ number_format(auth()->user()->image_credits + auth()->user()->image_credits_prepaid) }} @endif</h4>										
											</div>	
										@endif
									@endrole	
									@role('user|subscriber|admin')
																...
																<div class="card p-4 pl-5 prepaid-cards @if ($prepaid->featured) price-card-border @endif">
																	...
																	<div class="plan prepaid-plan">
																		...
																		<div class="credits-box">										 
																			...
																			@if ($prepaid->images != 0) <p class="fs-12 mt-2 mb-0"><i class="fa-solid fa-check fs-14 mr-2 text-success"></i> {{ __('Image Credits Included') }}: <span class="ml-2 font-weight-bold text-primary">{{ number_format($prepaid->images) }}</span></p>@endif																			
