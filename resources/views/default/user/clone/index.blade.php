									...
									<div class="col-lg-6 col-md-12 col-sm-12">
										<div class="form-group">									
											<select id="languages" name="language" class="form-select" data-placeholder="{{ __('Pick Your Language') }}:">	
												...
												<option value="bg-BG" data-img="{{ theme_url('img/flags/bg.svg') }}" @if (auth()->user()->default_voiceover_language == 'bg-BG') selected @endif> {{ __('Bulgarian (Bulgaria)') }}</option>										
												<option value="cmn-CN" data-img="{{ theme_url('img/flags/cn.svg') }}" @if (auth()->user()->default_voiceover_language == 'cmn-CN') selected @endif> {{ __('Chinese (Mandarin)') }}</option>										
												<option value="hr-HR" data-img="{{ theme_url('img/flags/hr.svg') }}" @if (auth()->user()->default_voiceover_language == 'hr-HR') selected @endif> {{ __('Croatian (Croatia)') }}</option>										
												<option value="cs-CZ" data-img="{{ theme_url('img/flags/cz.svg') }}" @if (auth()->user()->default_voiceover_language == 'cs-CZ') selected @endif> {{ __('Czech (Czech Republic)') }}</option>										
												...
												<option value="en-US" data-img="{{ theme_url('img/flags/us.svg') }}" @if (auth()->user()->default_voiceover_language == 'en-US') selected @endif> {{ __('English (USA)') }}</option>										
												<option value="fil-PH" data-img="{{ theme_url('img/flags/ph.svg') }}" @if (auth()->user()->default_voiceover_language == 'fil-PH') selected @endif> {{ __('Filipino (Philippines)') }}</option>										
												...
												<option value="fr-FR" data-img="{{ theme_url('img/flags/fr.svg') }}" @if (auth()->user()->default_voiceover_language == 'fr-FR') selected @endif> {{ __('French (France)') }}</option>										
												...
												<option value="id-ID" data-img="{{ theme_url('img/flags/id.svg') }}" @if (auth()->user()->default_voiceover_language == 'id-ID') selected @endif> {{ __('Indonesian (Indonesia)') }}</option>										
												...
												<option value="ko-KR" data-img="{{ theme_url('img/flags/kr.svg') }}" @if (auth()->user()->default_voiceover_language == 'ko-KR') selected @endif> {{ __('Korean (South Korea)') }}</option>										
												<option value="ms-MY" data-img="{{ theme_url('img/flags/my.svg') }}" @if (auth()->user()->default_voiceover_language == 'ms-MY') selected @endif> {{ __('Malay (Malaysia)') }}</option>										
												...
												<option value="sk-SK" data-img="{{ theme_url('img/flags/sk.svg') }}" @if (auth()->user()->default_voiceover_language == 'sk-SK') selected @endif> {{ __('Slovak (Slovakia)') }}</option>										
												...
												<option value="ta-MY" data-img="{{ theme_url('img/flags/my.svg') }}" @if (auth()->user()->default_voiceover_language == 'ta-MY') selected @endif> {{ __('Tamil (Malaysia)') }}</option>										
