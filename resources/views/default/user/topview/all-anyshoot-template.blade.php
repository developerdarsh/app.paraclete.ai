        ...
        <div class="modal-dialog modal-fullscreen">
            ...
            <div class="modal-body">
                    ...
                    <div class="filter-tabs">
                        <ul class="nav nav-pills flex-wrap" id="filterTabs">
                            ...
                            @foreach($categories['result'] as $category)
                                <li class="nav-item">
                                    <a class="nav-link" href="#" data-category="{{ $category['categoryId'] }}">
                    ...
                    <div class="avatar-grid" id="templateGrid">
                        ...
                        @foreach($template_list['result']['data'] as $template)
     ...
     // Handle filter tab clicks
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            loadMoreBtn.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '{{ route("avatars.anyshoot.templete.ajax") }}',
                    method: 'GET',
                    data: {
                        page: currentPage,
