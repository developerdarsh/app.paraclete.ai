                  ...
                  <div class="section-header">
                   <h5>Public Avatar</h5>
                    ...
                    <div class="avatar-grid" id="avatarGrid">
                        @foreach($avatars['result']['data'] as $avatar)
                            <a class="avatar-card" data-id="{{ $avatar['aiavatarId'] }}">
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row g-2">
            @foreach($captions['result'] as $caption)
                <div class="col-3">
                    <div class="border p-1 rounded text-center caption-item" 
                         data-caption-id="{{ $caption['captionId'] }}" 
                         style="cursor: pointer;">
                        <img src="{{ $caption['thumbnail'] }}" alt="Caption Thumbnail" class="img-fluid rounded">
                    </div>
                </div>
            @endforeach
        </div>
...
<script>
    ...
    $('#generateButton').on('click', function(e) {
        ...
        $.ajax({
            url: "{{ route('generate.avatar.video') }}", // Define route below
            type: 'POST',
            data: {
