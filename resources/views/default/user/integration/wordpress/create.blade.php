...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0"><i class="text-primary mr-2 fs-16 fa-brands fa-wordpress"></i>{{ __('Add Wordpress Website') }}</h4>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">				
				<div class="card-body pt-5">
					<form class="w-100" action="{{ route('user.integration.wordpress.website.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
						<div class="row justify-content-center">	
