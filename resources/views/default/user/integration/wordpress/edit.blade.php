...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		<h4 class="page-title mb-0"><i class="text-primary mr-2 fs-16 fa-brands fa-wordpress"></i>{{ __('Update Wordpress Website') }}</h4>
		<h6 class="text-muted">{{ __('Include your target Wordpress websites') }}</h6>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">				
				<div class="card-body pt-5">
					<form class="w-100" action="{{ route('user.integration.wordpress.website.update', $current->id) }}" method="POST" enctype="multipart/form-data">
						@method('PUT')
						@csrf
						<div class="row justify-content-center">	
							...
							<div class="col-lg-5 col-md-8 col-sm-12">
								...
								<div class="text-center mt-5">
									<img class="mb-4" style="max-width: 9rem" src="{{ theme_url('img/csp/wordpress.png') }}" alt="">	
								</div>								

								<p class="fs-14 text-muted text-center mb-7">{{ __('Provide your Wordpress connection informaiton') }}</p>
								...
								<div class="col-sm-12 text-center mb-5">
									<a href="{{ route('user.integration.wordpress.website.delete', [$current->id]) }}" class="ripple btn btn-cancel pl-8 pr-8">{{ __('Delete') }}</a>
