					...
					<div class="card-body pb-6">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/paystack.svg') }}" alt="Paystack" class="gateway-logo"><span class="text-primary">Paystack</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/razorpay.svg') }}" alt="Razorpay" class="gateway-logo"><span class="text-primary">Razorpay</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/mollie.svg') }}" alt="Mollie" class="gateway-logo gateway-small-logo"><span class="text-primary">Mollie</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/flutterwave.svg') }}" alt="Midtrans" class="gateway-logo"><span class="text-primary">Flutterwave</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/yookassa.svg') }}" alt="Midtrans" class="gateway-logo"><span class="text-primary">Yookassa</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/paddle.webp') }}" alt="Midtrans" class="gateway-logo"><span class="text-primary">Paddle</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/iyzico.svg') }}" alt="Midtrans" class="gateway-logo"><span class="text-primary">Iyzico</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/braintree.svg') }}" alt="Braintree" class="gateway-logo"><span class="text-primary">Braintree</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('Prepaid Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/midtrans.png') }}" alt="Midtrans" class="gateway-logo"><span class="text-primary">Midtrans</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('Prepaid Plans') }})</span></h6>
						...
						<div class="card border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/2checkout.webp') }}" alt="2Checkout" class="gateway-logo"><span class="text-primary">2Checkout</span> {{ __('Payment Gateway') }} <span class="text-primary">({{ __('All Plans') }})</span></h6>
					...
					<div class="card-body pb-6">
						...
						<div class="card overflow-hidden border-0 special-shadow">							
							<div class="card-body">
								...
								<h6 class="fs-12 font-weight-bold mb-4"><img src="{{ theme_url('/img/payments/coinbase.svg') }}" alt="Coinbase" class="gateway-logo">{{ __('Coinbase Commerce Payment Gateway') }} <span class="text-primary">({{ __('Prepaid Plans') }})</span></h6>
