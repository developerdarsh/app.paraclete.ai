								...
								<div class="card-body">
									...
									<div class="row">								
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												<h6>@if ($settings->model_credit_name == 'words'){{ __('Word Credits') }} @else {{ __('Token Credits') }}@endif <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
												<div class="form-group">							    
													<input type="number" class="form-control" id="tokens" name="tokens" value="{{ $id->tokens }}">
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												<h6>{{ __('Media Credits') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
												<div class="form-group">							    
													<input type="number" class="form-control" id="images" name="images" value="{{ $id->images }}">
													<span class="text-muted fs-10">{{ __('Valid for all media vendors') }}</span>
												</div> 
												@error('images')
