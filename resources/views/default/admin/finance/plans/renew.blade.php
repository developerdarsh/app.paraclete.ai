						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">							
								<div class="prepaid-view-box p-4">	
									<div class="input-box">
										<div class="form-group mt-3">
											<label class="custom-switch">
												<input type="checkbox" name="o1_preview_check" class="custom-switch-input">
												<span class="custom-switch-indicator"></span>
												<span class="ml-2 text-muted">{{ __('Include in renewal') }}</span>
											</label>
										</div>
									...
									<div class="input-box mb-0">							
										<h6>{{ __('o1 preview Model Credits') }}</h6>
										<div class="form-group">							    
							...
							<div class="col-md-6 col-sm-12">							
								<div class="prepaid-view-box p-4">	
									<div class="input-box">
										<div class="form-group mt-3">
											<label class="custom-switch">
												<input type="checkbox" name="o1_mini_check" class="custom-switch-input">
												<span class="custom-switch-indicator"></span>
												<span class="ml-2 text-muted">{{ __('Include in renewal') }}</span>
											</label>
										</div>
									...
									<div class="input-box mb-0">							
										<h6>{{ __('o1 mini Model Credits') }}</h6>
										<div class="form-group">							    
							...
							<div class="col-md-6 col-sm-12">							
								<div class="prepaid-view-box p-4">
									...
									<div class="input-box mb-0">							
										<h6>{{ __('Claude 3.5 Haiku Model Credits') }}</h6>
										<div class="form-group">							    
