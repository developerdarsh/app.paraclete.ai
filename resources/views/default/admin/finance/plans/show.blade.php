				...
				<div class="card border-0">
					...
					<div class="card-body pt-5">
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-12">
								<div class="prepaid-view-box text-center">
									<h6 class="text-muted fs-12 mb-1">{{ __('o1 preview Model Credits') }} </h6>
									<span class="fs-14 font-weight-semibold">@if ($id->o1_preview_credits == -1) {{ __('Unlimited') }} @else {{ number_format($id->o1_preview_credits) }} @endif</span>
								</div>							
							</div>
							<div class="col-lg-4 col-md-4 col-12">
								<div class="prepaid-view-box text-center">
									<h6 class="text-muted fs-12 mb-1">{{ __('o1 mini Model Credits') }} </h6>
									<span class="fs-14 font-weight-semibold">@if ($id->o1_mini_credits == -1) {{ __('Unlimited') }} @else {{ number_format($id->o1_mini_credits) }} @endif</span>
								</div>							
							</div>
							<div class="col-lg-4 col-md-4 col-12">
								<div class="prepaid-view-box text-center">
							...
							<div class="col-lg-4 col-md-4 col-12">
								<div class="prepaid-view-box text-center">
									<h6 class="text-muted fs-12 mb-1">{{ __('Claude 3.5 Haiku Model Credits') }} </h6>
							...
							<div class="col-lg-4 col-md-4 col-12">
								<div class="prepaid-view-box text-center">
									<h6 class="text-muted fs-12 mb-1">{{ __('Image Credits') }} </h6>
