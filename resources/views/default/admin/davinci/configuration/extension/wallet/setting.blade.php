...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Wallet System') }}</h4>
		...
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-body pt-7 pl-7 pr-7 pb-6">									
					<form action="{{ route('admin.davinci.configs.wallet.store') }}" method="post" enctype="multipart/form-data">
						@csrf
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box mb-0">
											<h6>{{ __('Enable/Disable Wallet System Feature') }}</h6>
											<div class="form-group mt-3">
												<label class="custom-switch">
													<input type="checkbox" name="wallet_feature" class="custom-switch-input" @if ($extension->wallet_feature) checked @endif>
