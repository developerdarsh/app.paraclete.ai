	...
	<div class="row mt-24">
		<div class="col-lg-12 col-md-12 col-sm-12 p-4">
			<div id="chat-search-panel">
				...
				<h3 class="page-title ml-2 mb-3">{{ __('AI Chat Assistants') }}</h3>
				<h6 class="text-muted mb-4 ml-2">{{ __('Find your AI assistant quickly! Get ready to explore our fantastic lineup of AI chat assistants') }}</h6>
