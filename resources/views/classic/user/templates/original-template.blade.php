				...
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-20 super-strong">{{ __($template->name) }} 										
					...
					<div class="row right-border">
						...
						@if ($brand_feature)
							...
							<div class="col-sm-12 brand-details">
								<div class="form-group mb-5">	
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Select Company') }}</h6>								
							...
							<div class="col-sm-12 brand-details">
								<div class="form-group mb-5">
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Select Product / Service') }} </h6>
						...
						@foreach ($fields as $value)
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __($value['name']) }} @if ($value['code'] == 'keywords') <span class="text-muted font-weight-normal">({{ __('comma seperated')  }})</span> @endif @if ($value['required']) <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> @endif</h6>									
									@if ($value['code'] == 'title')
						...
						<div class="col-sm-12">
							<div class="form-group">	
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('AI Model') }}</h6>								
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div id="form-group" class="mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Creativity') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Increase or decrease the creativity level to get various results') }}"></i></h6>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div id="form-group" class="mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Tone of Voice') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Set result tone of the text as needed') }}"></i></h6>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="input-box mb-0 mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Number of Results') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Maximum supported results is 50') }}"></i></h6>
								<div class="form-group">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box mt-5">								
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold">{{ __('Estimated Result Length') }} <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="{{ __('Estimated words length for each generated text result') }}"></i></h6>
								<div class="form-group">							    
