    ...
    <div class="container-fluid"> 
        <div class="d-flex">            
            ...
            <a class="header-brand w-100 text-center" href="{{ url('/') }}">
                <img src="{{theme_url('img/brand/logo.png')}}" class="header-brand-img desktop-lgo w-10 pt-2" alt="Polly logo">
                <img src="{{theme_url('img/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Polly logo">
            </a>
