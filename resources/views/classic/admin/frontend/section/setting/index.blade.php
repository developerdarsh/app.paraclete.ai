								...
								<div class="card shadow-0 mb-6">							
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">													
												<div class="input-box mb-3">								
													<h6>{{ __('How it Works Sub Title') }}</h6>
													<div class="form-group">							    
								...
								<div class="card shadow-0 mb-6">							
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-12 col-sm-12">													
												<div class="input-box mb-3">								
													<h6>{{ __('Images Banner Sub Title') }}</h6>
													<div class="form-group">							    
