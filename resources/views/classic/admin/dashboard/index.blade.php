					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-12">
							<div class="mb-6">
								...
								<p class="text-muted fs-11 data-percentage-change mb-2"><span id="income_change"></span> {{ __('this month') }}</p>
							</div>
							<div class="mb-6">
							...
							<div>
								...
								<p class="text-muted fs-11 data-percentage-change mb-2"><span id="subscribers_change"></span> {{ __('this month') }}</p>
							</div>
						</div>
