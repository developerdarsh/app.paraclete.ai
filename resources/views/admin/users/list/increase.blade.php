					...
					<form method="POST" action="{{ route('admin.user.increase', [$user->id]) }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-2">
								...
								<div class="row mt-4">
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2">{{ __('Available o1 mini Model Words') }}: <span class="font-weight-bold ml-2">@if ($user->o1_mini_credits == -1) {{ __('Unlimited') }} @else {{ number_format($user->o1_mini_credits) }} @endif</span></p>
										<p class="fs-12 mb-2">{{ __('Available o1 preview Model Words') }}: <span class="font-weight-bold ml-2">@if ($user->o1_preview_credits == -1) {{ __('Unlimited') }} @else {{ number_format($user->o1_preview_credits) }} @endif</span></p>
										...
										<p class="fs-12 mb-2">{{ __('Available Claude 3.5 Sonnet Model Words') }}: <span class="font-weight-bold ml-2">@if ($user->claude_3_sonnet_credits == -1) {{ __('Unlimited') }} @else {{ number_format($user->claude_3_sonnet_credits) }} @endif</span></p>
										<p class="fs-12 mb-2">{{ __('Available Claude 3.5 Haiku Model Words') }}: <span class="font-weight-bold ml-2">@if ($user->claude_3_haiku_credits == -1) {{ __('Unlimited') }} @else {{ number_format($user->claude_3_haiku_credits) }} @endif</span></p>
										...
										<p class="fs-12 mb-2">{{ __('Available Image Credits') }}: <span class="font-weight-bold ml-2">@if ($user->image_credits == -1) {{ __('Unlimited') }} @else {{ number_format($user->image_credits ) }} @endif</span></p>										
									...
									<div class="col-sm-12 col-md-6">
										...
										<p class="fs-12 mb-2">{{ __('Available Prepaid o1 mini Model Words') }}: <span class="font-weight-bold ml-2">{{ number_format($user->o1_mini_credits_prepaid) }}</span></p>
										<p class="fs-12 mb-2">{{ __('Available Prepaid o1 preview Model Words') }}: <span class="font-weight-bold ml-2">{{ number_format($user->o1_preview_credits_prepaid) }}</span></p>
										...
										<p class="fs-12 mb-2">{{ __('Available Prepaid Claude 3.5 Sonnet Model Words') }}: <span class="font-weight-bold ml-2">{{ number_format($user->claude_3_sonnet_credits_prepaid) }}</span></p>
										<p class="fs-12 mb-2">{{ __('Available Prepaid Claude 3.5 Haiku Model Words') }}: <span class="font-weight-bold ml-2">{{ number_format($user->claude_3_haiku_credits_prepaid) }}</span></p>
										...
										<p class="fs-12 mb-2">{{ __('Available Prepaid Image Credits') }}: <span class="font-weight-bold ml-2">{{ number_format($user->image_credits_prepaid) }}</span></p>										
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User o1 mini Credits') }}</label>
										<input type="number" class="form-control @error('o1-mini') is-danger @enderror" value={{ $user->o1_mini_credits }} name="o1-mini">
										<span class="text-muted fs-10">{{ __('Set as -1 for unlimited words') }}</span>									
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Prepaid o1 mini Credits') }}</label>
										<input type="number" class="form-control @error('o1-mini-prepaid') is-danger @enderror" value={{ $user->o1_mini_credits_prepaid }} name="o1-mini-prepaid">								
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User o1 preview Credits') }}</label>
										<input type="number" class="form-control @error('o1-preview') is-danger @enderror" value={{ $user->o1_mini_credits }} name="o1-preview">
										<span class="text-muted fs-10">{{ __('Set as -1 for unlimited words') }}</span>									
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Prepaid o1 preview Credits') }}</label>
										<input type="number" class="form-control @error('o1-preview-prepaid') is-danger @enderror" value={{ $user->o1_preview_credits_prepaid }} name="o1-preview-prepaid">								
									</div>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Claude 3.5 Sonnet Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Prepaid Claude 3.5 Sonnet Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Claude 3.5 Haiku Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6 mt-3">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-scroll-old mr-2 text-info"></i>{{ __('User Prepaid Claude 3.5 Haiku Credits') }}</label>
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Image Credits') }}</label>
										<input type="number" class="form-control @error('dalle-images') is-danger @enderror" value={{ $user->image_credits }} name="image-credits">
							...
							<div class="col-sm-12 col-md-6">
								<div class="input-box mb-4">
									<div class="form-group">
										<label class="form-label fs-12 font-weight-bold"><i class="fa-solid fa-image mr-2 text-info"></i>{{ __('User Prepaid Image Credits') }}</label>
										<input type="number" class="form-control @error('dalle_images_prepaid') is-danger @enderror" value={{ $user->image_credits_prepaid }} name="image-credits-prepaid">								
									</div>
								</div>
							</div>
