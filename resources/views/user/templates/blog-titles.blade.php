					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=5 class="form-control @error("description") is-danger @enderror" id="description" name="description" placeholder="{{ __('e.g. Describe your blog post') }}" required></textarea>
									@error('description')
