                             ...
                             <!--   @if(isset($template))
								...
								<div class="flex mt-3">
										...
										<!-- <a class="dropdown-selected">
												<button class="btn cs-btn dropdown-toggle fs-11 text-muted mb-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
													Conversational Starters
												</button>
												<ul class="dropdown-menu s-dropdown-menu">
													@foreach($template as $t)
												...
												<div class="card border-0" onclick='applyPrompt("{{ __($prompt->prompt) }}")'>
													<div class="card-body pt-3">
														...
														<div class="template-info">
															<span style="display:none">{{ $prompt->group }}</span>
...
<script type="text/javascript">
	...
	$(document).on('keyup', '#search-template', function () {
		...
		$('#templates-panel').find('> div').each(function () {
			if ($(this).filter(function() {
				return (($(this).find('h6').text().toLowerCase().indexOf(searchTerm) > -1) || ($(this).find('p').text().toLowerCase().indexOf(searchTerm) > -1) || ($(this).find('span').text().toLowerCase().indexOf(searchTerm) > -1) );
