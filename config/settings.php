...
return [
    ...
    */
    ...
    'smart_ads_feature_user' => env('DAVINCI_SETTINGS_SMART_ADS_FEATURE_USER'),
    'elementor_feature_user' => env('DAVINCI_SETTINGS_ELEMENTOR_FEATURE_USER'),
    'training_video_feature_user' => env('DAVINCI_SETTINGS_TRAINING_VIDEO_FEATURE_USER'),
    'ai_ugc_video_feature_user' => env('DAVINCI_SETTINGS_AI_UGC_VIDEO_FEATURE_USER'),
    'media_editor_feature_user' => env('DAVINCI_SETTINGS_MEDIA_EDITOR_FEATURE_USER'),
    'rss_feature_user' => env('DAVINCI_SETTINGS_RSS_FEATURE_USER'),
    'builder_feature_user' => env('DAVINCI_SETTINGS_BUILDER_FEATURE_USER'),
    'resume_feature_user' => env('DAVINCI_SETTINGS_RESUME_FEATURE_USER'),
