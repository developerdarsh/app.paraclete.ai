            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                          ...
                          <ul class="nav nav-pills flex-wrap" id="filterTabs">
                            ...
                            <?php $__currentLoopData = $categories['result']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                   ...
                                   onclick="selectCategory('<?php echo e($category['categoryId']); ?>')">
                    ...
                    <div class="avatar-grid" id="avatarGrid">
                        ...
                        <!-- Avatar Templates -->
                        <!-- Avatar Cards -->
                        <?php $__currentLoopData = $product_avatar_temp['result']['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $avatar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="avatar-card" 
                                data-avatar="<?php echo e($avatar['avatarId']); ?>"
                                data-category="<?php echo e(collect($avatar['avatarCategoryList'])->pluck('categoryName')->implode(' ') ?: 'general all'); ?>">
                                
                                <?php if($avatar['minSubsType'] !== 'starter'): ?>
                                    <div class="premium-badge">VIP</div>
                                <?php endif; ?>

                                <img src="<?php echo e(trim($avatar['avatarImagePath'])); ?>" alt="Avatar" class="avatar-image">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-6 mb-4">
                            <div class="image-upload-container position-relative" style="height: 400px; border-radius: 15px; overflow: hidden; background: #2a2a2a;">
                                <img id="avatarPreview" src="<?php echo e(trim($avatar['avatarImagePath'])); ?>" 
  ...
  <!-- Video Preview Modal -->
   ...
   <!-- Create Avatar Modal -->
    ...
    <script src="<?php echo e(theme_url('js/export-chat.js')); ?>"></script>
     ...
     <script>
        ...
        function loadAvatars(categoryId = selectedCategory, page = pageNo) {
            ...
            let urlTemplate = `<?php echo e(route('category.products', ['categoryId' => 'REPLACE', 'pageNo' => 'PAGE'])); ?>`;
        ...
        document.getElementById('generateBtn').addEventListener('click', function () {
            ...
            fetch('<?php echo e(route("avatar.generate.template")); ?>', { 
                method: 'POST',
                headers: {
        ...
        function uploadProductImageToServer(file) {
            ...
            fetch('<?php echo e(route("product.image.upload")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/topview/all-product-template.blade.php ENDPATH**/ ?>