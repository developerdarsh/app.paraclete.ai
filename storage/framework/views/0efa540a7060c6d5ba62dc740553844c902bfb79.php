				...
				<div class="card-body">		
					...
					<div class="d-flex mb-3">
						<div class="d-flex text-right" id="template-buttons-group">	
							<?php if(config('settings.integration_feature_user')): ?>
								<div class="btn-group mt-1 publish-action-buttons">
									...
									<div class="dropdown-menu" aria-labelledby="export" data-popper-placement="bottom-start">								
										<a class="dropdown-item" href="<?php echo e(route('user.documents.publish', $id)); ?>"><i class="fa-brands fa-wordpress fs-13 text-muted mr-2"></i> <?php echo e(__('Publish to Wordpress')); ?></a>
									</div>
								</div>
							<?php endif; ?>										
							...
							<a id="save-button-template" class="template-button" target="<?php echo e($id->id); ?>" onclick="return saveText(this);" href="#"><i class="fa-solid fa-floppy-disk-pen table-action-buttons table-action-buttons-big delete-action-button" data-tippy-content="<?php echo e(__('Save Document')); ?>"></i></a>				
						</div>					
					</div>
...
unset($__errorArgs, $__bag); ?>
					...
					<div>						
						<div id="template-textarea" class="pl-4 pr-4 show-text-result">		
							...
							<?php endif; ?>				
							<div class="form-control" name="content" rows="25" id="tinymce-editor"><?php echo $id->result_text; ?></div>
...
unset($__errorArgs, $__bag); ?>	
					...
					<div class="border-0 text-center mb-5 mt-5">
						<a href="<?php echo e(route('user.documents')); ?>" class="btn btn-primary ripple pl-7 pr-7"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/documents/documents/show.blade.php ENDPATH**/ ?>