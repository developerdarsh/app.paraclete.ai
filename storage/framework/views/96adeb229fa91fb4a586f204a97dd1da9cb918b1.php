				...
				<div class="card-body pt-5">									
					<form id="" action="<?php echo e(route('admin.davinci.configs.image.credits.store')); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="row pl-5 pr-5">							
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><?php echo e(__('Stable Diffusion 3.5 Large')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><?php echo e(__('Stable Diffusion 3.5 Large Turbo')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><?php echo e(__('Stable Diffusion 3.5 Medium')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<div class="form-group">							    
						...
						<?php if(App\Services\HelperService::extensionMidjourney()): ?>
							<h6 class="text-muted text-center"><?php echo e(__('Midjourney')); ?></h6>

							<div class="row pl-5 pr-5">							

								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6><?php echo e(__('Midjourney Fast')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="midjourney_fast" value="<?php echo e($credits->midjourney_fast); ?>">
										</div> 	
									</div> 						
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6><?php echo e(__('Midjourney Relax')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="midjourney_relax" value="<?php echo e($credits->midjourney_relax); ?>">
										</div> 	
									</div> 						
								</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6><?php echo e(__('Midjourney Turbo')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="midjourney_turbo" value="<?php echo e($credits->midjourney_turbo); ?>">
										</div> 	
									</div> 						
								</div>								
							</div>
						...
						<?php if(App\Services\HelperService::extensionClipdrop()): ?>
							<h6 class="text-muted text-center"><?php echo e(__('Clipdrop')); ?></h6>

							<div class="row pl-5 pr-5">							

								<div class="col-lg-12 col-md-12 col-sm-12">							
									<div class="input-box">								
										<h6><?php echo e(__('Clipdrop')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
										<div class="form-group">							    
											<input type="number" min=1 class="form-control" name="clipdrop" value="<?php echo e($credits->clipdrop); ?>">
										</div> 	
									</div> 						
								</div>							
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/davinci/configuration/image.blade.php ENDPATH**/ ?>