					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2">
								<div>
									<h6 class="page-title mb-2"><?php echo e(__('AI ReWriter')); ?></h6>
...
unset($__errorArgs, $__bag); ?>
		...
		<div class="col-lg-7 col-md-12 col-sm-12 mt-5-7">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/rewriter/index.blade.php ENDPATH**/ ?>