...
<?php $__env->startSection('content'); ?>	
	<div class="row">
		<div class="col-lg-6 col-md-12 col-sm-12">
			<div class="card pb-0 dashboard-fixed-457" id="admin-dashboard-panels">
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-12">
							<div class="mb-6">
								...
								<p class="text-muted fs-11 data-percentage-change mb-2"><span id="income_change"></span> <?php echo e(__('this month')); ?></p>
							</div>
							<div class="mb-6">
							...
							<div>
								...
								<p class="text-muted fs-11 data-percentage-change mb-2"><span id="subscribers_change"></span> <?php echo e(__('this month')); ?></p>
							</div>
						</div>
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12 mt-3">
			<div class="card overflow-hidden dashboard-fixed-457" id="admin-dashboard-panels">
				<div class="card-header pt-4 pb-4 border-0">
					<div class="mt-3">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 mt-3">
			<div class="card dashboard-fixed-457" id="admin-dashboard-panels" style="max-height: 457px;">
				<div class="card-header pt-4 pb-4 border-0">
					<div class="mt-3">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 mt-3 no-gutters">
			<div class="row">
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			gradientStroke.addColorStop(0, '#533afd');
			gradientStroke.addColorStop(1, chartColor);
			let gradientFill = ctx2.createLinearGradient(0, 170, 0, 50);
			gradientFill.addColorStop(0, "rgba(83, 58, 253, 0)");
			gradientFill.addColorStop(1, "rgba(83, 58, 253, 0.4)");
						...
						success: function (data) {
							...
							if (data['status'] == 200) {
								...
								<?php if(!empty(config('services.google.analytics.property')) && !empty(config('services.google.analytics.credentials'))): ?>
									...
									gradientStroke3.addColorStop(0, '#533afd');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/admin/dashboard/index.blade.php ENDPATH**/ ?>