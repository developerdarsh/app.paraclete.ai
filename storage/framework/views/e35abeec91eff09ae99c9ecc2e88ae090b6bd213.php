			...
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					...
					<form action="<?php echo e(route('admin.settings.oauth.store')); ?>" method="POST" enctype="multipart/form-data">
						...
						<h3 class="card-title text-center mb-5"><?php echo e(__('Setup OAuth Login')); ?></h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/settings/oauth/index.blade.php ENDPATH**/ ?>