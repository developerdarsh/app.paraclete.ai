	...
	<div class="row">
		<div class="col-xl-3 col-lg-3 col-md-12">
			<div class="card">
							...
							<div class="text-center p-2">
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->gpt_4_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->gpt_4_credits + $user->gpt_4_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('GPT 4 Model Words')); ?></h6>
									</div>		
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->gpt_4_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->gpt_4_turbo_credits + $user->gpt_4_turbo_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('GPT 4 Turbo Model Words')); ?></h6>
									</div>	
								</div>
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->gpt_3_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->gpt_3_turbo_credits + $user->gpt_3_turbo_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('GPT 3.5 Turbo Model Words')); ?></h6>
									</div>	
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->fine_tune_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->fine_tune_credits + $user->fine_tune_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Fine Tune Model Words')); ?></h6>
									</div>										
								</div>
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->claude_3_opus_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->claude_3_opus_credits + $user->claude_3_opus_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Claude 3 Opus Model Words')); ?></h6>
									</div>	
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->claude_3_sonnet_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->claude_3_sonnet_credits + $user->claude_3_sonnet_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Claude 3 Sonnet Model Words')); ?></h6>
									</div>											
								</div>
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->claude_3_haiku_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->claude_3_haiku_credits + $user->claude_3_haiku_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Claude 3 Haiku Model Words')); ?></h6>
									</div>
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->gemini_pro_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->gemini_pro_credits + $user->gemini_pro_credits_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Gemini Pro Model Words')); ?></h6>
									</div>									
								</div>
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->available_dalle_images == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_dalle_images + $user->available_dalle_images_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Dalle Images Left')); ?></h6>
									</div>	
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->available_sd_images == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_sd_images + $user->available_sd_images_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('SD Images Left')); ?></h6>
									</div>	
								</div>	
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->available_chars == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_chars + $user->available_chars_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Characters Left')); ?></h6>
									</div>			
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->available_minutes == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_minutes + $user->available_minutes_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Minutes Left')); ?></h6>
									</div>	
								</div>
							</div>
						</div>
				...
				<div class="widget-user-image overflow-hidden mx-auto mt-5"><img alt="User Avatar" class="rounded-circle" src="<?php if($user->profile_photo_path): ?> <?php echo e($user->profile_photo_path); ?> <?php else: ?> <?php echo e(theme_url('img/users/avatar.jpg')); ?> <?php endif; ?>"></div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card mb-5">
									...
									<div class="w-30">
										<div class="form-group mt-3">
											<label class="custom-switch">
												...
												<span class="custom-switch-description"><?php echo e(__('Show Hidden Plans')); ?></span>
											</label>
										</div>
									</div>
								<?php endif; ?>
						...
						<div class="card-body">
							<div class="mb-3">
								<?php if($user_subscription == ''): ?>
									<span class="fs-12 text-muted"><?php echo e(__('Total GPT 3.5 Turbo words available')); ?>: <?php if($user->gpt_3_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->available_words)); ?> <?php endif; ?>.</span> <span class="fs-12 text-muted"><?php echo e(__('Total prepaid words available ')); ?> <?php echo e(number_format($user->available_words_prepaid)); ?>. </span>
								<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/admin/users/list/show.blade.php ENDPATH**/ ?>