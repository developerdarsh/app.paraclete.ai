								...
								<div class="row">
									<div class="col-md-6 col-sm-12">							
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="number" class="form-control" id="token-credits" name="token-credits" value="<?php echo e($id->token_credits); ?>" placeholder="0">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" id="smart_ads_feature" name="smart_ads_feature" class="custom-switch-input" <?php if($id->smart_ads_feature == 1): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
						...
						<div class="card mt-7 mb-7 shadow-0">
							<div class="card-body">
								...
								<div class="row">								
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select class="form-select" id="templates-models-list" name="templates_models_list[]" data-placeholder="<?php echo e(__('Choose Models for Templates')); ?>" multiple>
												<option value="gpt-3.5-turbo-0125" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-3.5-turbo-0125'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 3.5 Turbo')); ?></option>												
												<option value="gpt-4" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4')); ?></option>
												<option value="gpt-4o" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4o'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4o')); ?></option>
												<option value="gpt-4o-mini" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4o-mini'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4o mini')); ?></option>
												<option value="gpt-4-0125-preview" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4-0125-preview'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4 Turbo')); ?></option>	
												<option value="gpt-4.5-preview" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4.5-preview'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4.5')); ?></option>	
												<option value="o1" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o1'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o1')); ?> </option>	
												<option value="o1-mini" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o1-mini'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o1 mini')); ?> </option>	
												<option value="o3-mini" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o3-mini'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o3 mini')); ?> </option>	
												...
												<option value='claude-3-7-sonnet-20250219' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-7-sonnet-20250219'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3.7 Sonnet')); ?></option>
												...
												<option value='gemini-1.5-pro' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-1.5-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 1.5 Pro')); ?></option>																																																																																																																										
												<option value='gemini-1.5-flash' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-1.5-flash'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 1.5 Flash')); ?></option>																																																																																																																										
												<option value='gemini-2.0-flash' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-2.0-flash'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 2.0 Flash')); ?></option>
												<option value='deepseek-chat' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'deepseek-chat'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('DeepSeek V3')); ?></option>
												<option value='deepseek-reasoner' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'deepseek-reasoner'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('DeepSeek R1')); ?></option>
												<option value='grok-2-1212' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'grok-2-1212'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Grok 2')); ?></option>
												<option value='grok-2-vision-1212' <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'grok-2-vision-1212'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Grok 2 Vision')); ?></option>
												<?php if(App\Services\HelperService::extensionPerplexity()): ?>	
													<option value="sonar" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar')); ?></option>
													<option value="sonar-pro" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar Pro')); ?></option>
													...
													<option value="sonar-reasoning-pro" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar-reasoning-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar Reasoning Pro')); ?></option>
												<?php endif; ?>	
												<?php if(App\Services\HelperService::extensionAmazonBedrock()): ?>	
													<option value="us.amazon.nova-micro-v1:0" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-micro-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Micro')); ?></option>
													<option value="us.amazon.nova-lite-v1:0" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-lite-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Lite')); ?></option>
													<option value="us.amazon.nova-pro-v1:0" <?php $__currentLoopData = $model_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-pro-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Pro')); ?></option>
												<?php endif; ?>	
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select class="form-select" id="chats-models-list" name="chats_models_list[]" data-placeholder="<?php echo e(__('Choose Models for Chat Bots')); ?>" multiple>
												...
												<option value="gpt-4" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4')); ?></option>												
												<option value="gpt-4o" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4o'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4o')); ?></option>	
												...
												<option value="gpt-4.5-preview" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gpt-4.5-preview'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI GPT 4.5')); ?></option>
												<option value="o1" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o1'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o1')); ?> </option>	
												<option value="o1-mini" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o1-mini'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o1 mini')); ?> </option>	
												<option value="o3-mini" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'o3-mini'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('OpenAI o3 mini')); ?> </option>	
												<option value='claude-3-opus-20240229' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-opus-20240229'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3 Opus')); ?></option>
												<option value='claude-3-7-sonnet-20250219' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-7-sonnet-20250219'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3.7 Sonnet')); ?></option>																																																																																																																											
												<option value='claude-3-5-sonnet-20241022' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'claude-3-5-sonnet-20241022'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Claude 3.5 Sonnet')); ?></option>																																																																																																																											
												...
												<option value='gemini-1.5-pro' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-1.5-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 1.5 Pro')); ?></option>
												<option value='gemini-1.5-flash' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-1.5-flash'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 1.5 Flash')); ?></option>
												<option value='gemini-2.0-flash' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'gemini-2.0-flash'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Gemini 2.0 Flash')); ?></option>
												<option value='deepseek-chat' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'deepseek-chat'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('DeepSeek V3')); ?></option>
												<option value='deepseek-reasoner' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'deepseek-reasoner'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('DeepSeek R1')); ?></option>
												<option value='grok-2-1212' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'grok-2-1212'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Grok 2')); ?></option>
												<option value='grok-2-vision-1212' <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'grok-2-vision-1212'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Grok 2 Vision')); ?></option>
												<?php if(App\Services\HelperService::extensionPerplexity()): ?>	
													<option value="sonar" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar')); ?></option>
													<option value="sonar-pro" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar Pro')); ?></option>
													<option value="sonar-reasoning" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar-reasoning'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar Reasoning')); ?></option>
													<option value="sonar-reasoning-pro" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'sonar-reasoning-pro'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Perplexity Sonar Reasoning Pro')); ?></option>
												<?php endif; ?>
												<?php if(App\Services\HelperService::extensionAmazonBedrock()): ?>	
													<option value="us.amazon.nova-micro-v1:0" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-micro-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Micro')); ?></option>
													<option value="us.amazon.nova-lite-v1:0" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-lite-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Lite')); ?></option>
													<option value="us.amazon.nova-pro-v1:0" <?php $__currentLoopData = $model_chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($value == 'us.amazon.nova-pro-v1:0'): ?> selected <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>><?php echo e(__('Nova Pro')); ?></option>
												<?php endif; ?>
												<?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><?php echo e(__('Supported AI Voiceover Vendors')); ?> <i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Only listed TTS voices of the listed vendors will be available for the subscriber. Make sure to include respective vendor API keys in the Paraclete settings page.')); ?>."></i></h6>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												<h6><?php echo e(__('Included AI Image Vendors')); ?> <i class="ml-3 text-dark fs-13 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Only listed AI Image vendors models will be available for the subscriber. Make sure to include respective vendor API keys in the Paraclete settings page.')); ?>."></i></h6>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="seo-feature" class="custom-switch-input" <?php if($id->seo_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="social-media-feature" class="custom-switch-input" <?php if($id->social_media_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="chat-share-feature" class="custom-switch-input" <?php if($id->chat_share_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="textract-feature" class="custom-switch-input" <?php if($id->textract_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="chat_realtime_feature" class="custom-switch-input" <?php if($id->chat_realtime_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
									...
									<div class="row subscription-extension-row">	
										...
										<div class="col-sm-12">
											<div class="input-box">
												...
												<div class="form-group mt-3">
													<label class="custom-switch">
														<input type="checkbox" name="chatbot_external_feature" class="custom-switch-input"  <?php if($id->chatbot_external_feature == true): ?> checked <?php endif; ?>>
														<span class="custom-switch-indicator"></span>
													</label>
												</div>
											</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0" name="chatbot_external_quantity" value="<?php echo e($id->chatbot_external_quantity); ?>">
												</div> 
											</div> 						
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" min="0" name="chatbot_external_domains" value="<?php echo e($id->chatbot_external_domains); ?>">
												</div> 
											</div> 						
										</div>
									</div>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/finance/plans/finance_subscription_edit.blade.php ENDPATH**/ ?>