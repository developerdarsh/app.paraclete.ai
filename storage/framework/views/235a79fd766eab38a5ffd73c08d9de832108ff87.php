							...
							<div class="text-center p-2">	
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->tokens == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->tokens + $user->tokens_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php if($settings->model_credit_name == 'words'): ?> <?php echo e(__('Words Left')); ?> <?php else: ?> <?php echo e(__('Tokens Left')); ?> <?php endif; ?></h6>
									</div>			
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->images == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->images + $user->images_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Media Credits Left')); ?></h6>
									</div>	
								</div>							
								<div class="d-flex w-100">
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->characters == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->characters + $user->characters_prepaid)); ?> <?php endif; ?></h4>
										<h6 class="fs-11 mb-3 text-muted"><?php echo e(__('Characters Left')); ?></h6>
									</div>			
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-bold fs-14"><?php if($user->minutes == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->minutes + $user->minutes_prepaid)); ?> <?php endif; ?></h4>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card mb-5 border-0">
						<div class="card-header d-inline border-0">
							...
							<?php if(is_null($user_subscription) || $user_subscription == ''): ?>
								<div>
						...
						<div class="card-body">
							<div class="mb-3">
								<span class="fs-12 text-muted"><?php echo e(__('Total words available via subscription plan')); ?>: <?php if($user->tokens == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format($user->tokens)); ?> <?php endif; ?>.</span> <span class="fs-12 text-muted"><?php echo e(__('Total prepaid words available ')); ?>: <?php echo e(number_format($user->tokens_prepaid)); ?>. </span>
							</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/users/list/show.blade.php ENDPATH**/ ?>