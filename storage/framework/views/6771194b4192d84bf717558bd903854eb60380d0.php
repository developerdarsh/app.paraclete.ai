	...
	<div class="page-header mt-5-7 justify-content-center"> 
		<div class="page-leftheader text-center">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item"><a href="<?php echo e(route('admin.davinci.chats')); ?>"> <?php echo e(__('Original Chatbots')); ?></a></li>
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-3">
                <div class="chat-logo-image overflow-hidden">
                  <img class="rounded-circle" src="<?php echo e(theme_url($chat->logo)); ?>" alt="Main Logo">
                </div>
              </div>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-md-6 col-sm-12">
                <div class="input-box">
                  <h6><?php echo e(__('Chat Bot Package')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
                  <select id="chats" name="category" class="form-control">
                    <option value="free" <?php if($chat->category == 'free'): ?> selected <?php endif; ?>><?php echo e(__('Free Package')); ?> (<?php echo e(__('Access only to Free Chatbots')); ?>)</option>																																											
                    <option value="standard" <?php if($chat->category == 'standard'): ?> selected <?php endif; ?>> <?php echo e(__('Standard Package')); ?> (<?php echo e(__('Access up to Standard Package')); ?>)</option>
                    <option value="professional" <?php if($chat->category == 'professional'): ?> selected <?php endif; ?>> <?php echo e(__('Professional Package')); ?> (<?php echo e(__('Access up to Professional Package')); ?>)</option>
                    <option value="premium" <?php if($chat->category == 'premium'): ?> selected <?php endif; ?>> <?php echo e(__('Premium Package')); ?> (<?php echo e(__('Access up to Premium Package')); ?>)</option>																																																														
                  </select>
                </div>
              </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="modal-footer d-inline">
              <div class="row text-center">
                <div class="col-md-12">
                  <a href="<?php echo e(route('admin.davinci.chats')); ?>" class="btn btn-cancel mr-2 pl-7 pr-7 ripple"><?php echo e(__('Return')); ?></a>
                  <button type="submit" class="btn btn-primary pl-7 pr-7 ripple"><?php echo e(__('Update')); ?></button>
                </div>
              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/davinci/chats/edit.blade.php ENDPATH**/ ?>