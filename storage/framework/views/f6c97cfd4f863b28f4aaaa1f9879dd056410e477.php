    ...
    <header class="header-1">
        <div class="container">
           <!-- <div class="sec-title text-center mb-3">
                 <h2>Untitled</h2>
                 <a href="#"><img src="<?php echo e(URL::asset('img/resume/flag.png')); ?>" alt="" /> English</a>
           </div>
           <div class="progress-section"> 
			...
			<div class="text-center mb-5"><a class="info-btn-alt" data-bs-toggle="modal" data-bs-target="#info-alert-model" href="javascript:void(0)">How It works ?</a></div>
            <div class="resume-templates">
                <h3>Choose a Resume Template</h3>
                <div class="template-images">
                    <div class="slider lazy">
                        <div class="img">
                            <img data-lazy="<?php echo e(URL::asset('img/resume/template1.jpg')); ?>" alt="Template 1" onclick="selectTemplate(this, '1')"/>
                        </div>
                        <div class="img">
                            <img data-lazy="<?php echo e(URL::asset('img/resume/template2.jpg')); ?>" alt="Template 2" onclick="selectTemplate(this, '2')">
                        </div>
                        <div class="img">
                            <img data-lazy="<?php echo e(URL::asset('img/resume/template3.jpg')); ?>" alt="Template 3" onclick="selectTemplate(this, '3')">
                        </div>
                        <div class="img">
                            <img data-lazy="<?php echo e(URL::asset('img/resume/template4.jpg')); ?>" alt="Template 4" onclick="selectTemplate(this, '4')"/>
                        </div>
                        <div class="img">
                            <img data-lazy="<?php echo e(URL::asset('img/resume/template5.jpg')); ?>" alt="Template 5" onclick="selectTemplate(this, '5')"/>
                        </div>
                    </div>
                </div>
	...
	<div class="modal fade" id="info-alert-model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true" role="dialog">
		<div class="modal-dialog modal-dialog-centered modal-xl">
			...
			<div class="modal-body">
				<div class="row">
					<!--ARCADE EMBED START--><div style="position: relative; padding-bottom: calc(56.25% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/4tFRvdAD6sSr9LReoYEZ?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="AI Resume" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div><!--ARCADE EMBED END-->
				</div>
			</div>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/resume/index.blade.php ENDPATH**/ ?>