    ...
    <div class="auto-container" style="width: 100%; max-width: 750px; margin-right: auto; margin-left: auto;">
        <div class="top-header" style="background-color: #303030;width: 100%;display: inline-block;">
            <div class="logo" style="width: 30%;height: 140px;float: left;">
                ...
                <?php else: ?>
                    <img src="<?php echo e(URL::asset('img/resume/default_img.jpg')); ?>" style="width: 100%;height: 178px;object-fit: cover;object-position: center;" />
                <?php endif; ?>    
            </div>
            <div class="User-Info" style="">
                <div class="User_Name" style="padding: 15px;">
                    <h2 style="margin: 0px; padding: 0px; font-size: 24px; line-height: 30px; font-weight: bold; color: #ffffff;"><?php echo e($data['first_name']); ?> <?php echo e($data['last_name']); ?></h2>
                ...
                <div class="User_Address" style="padding: 10px 15px 5px;">
                    <p style="margin: 0; padding: 0; color: #ffffff; font-size: 14px; line-height: 16px;"><?php echo e($data['address']); ?> <?php echo e($data['city']); ?>, <?php echo e($data['country']); ?>-<?php echo e($data['postal_code']); ?></p>
                     ...
                     <ul style="list-style: none;padding: 0px;">
                        ...
                        <li style="font-size: 12px;line-height: 16px;margin: 0px;padding:0px;">
                            ...
                            <div style="width: 100%;display: inline-block;background: #cecece;height: 4px;">
                                <?php if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='novice')): ?>
                                <div style="float: left;width: 20%;height: 4px;background: #000000;"></div>
                                <?php endif; ?>

                                <?php if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='beginner')): ?>
                                <div style="float: left;width: 40%;height: 4px;background: #000000;"></div>
                                <?php endif; ?>

                                <?php if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='intermediate')): ?>
                                <div style="float: left;width: 60%;height: 4px;background: #000000;"></div>
                                <?php endif; ?>

                                <?php if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='advanced')): ?>
                ...
                <div style="padding: 20px 20px 0px;"> 
                    ...
                    <div class="Employment-History"> 
                        ...
                        <ul class="skill-list" style="padding: 0px;padding-bottom: 20px;margin: 0px;">
                           <p style="font-size: 12px;line-height: 16px;margin: 0px;padding-bottom: 10px;"> <?php echo e($data['emp_description'][$key]); ?></p>
                         </ul>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="Education"> 
...
<?php /**PATH /var/www/html/public_html/resources/views/default/user/resume/template1.blade.php ENDPATH**/ ?>