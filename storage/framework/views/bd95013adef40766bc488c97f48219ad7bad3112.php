		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">	
				...
				<div class="card-body pt-5">
					<form class="w-100" action="<?php echo e(route('user.templates.custom.update', $id)); ?>" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">								
									...
									<?php $__currentLoopData = $id->fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<div class="field input-group mb-4">
											...
											<?php if($value['input'] == 'input' || $value['input'] == 'textarea'): ?>
											...
											<?php else: ?>
											 	<input type="text" class="form-control" name="placeholders[]" placeholder="<?php $__currentLoopData = $value['placeholder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($option); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" value="<?php $__currentLoopData = $value['placeholder']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($option); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
											<?php endif; ?>											
											<select class="form-select mr-4" name="input_field[]" onchange="notifyUser(this)">
												...
												<option value="select" <?php if($value['input'] == 'select'): ?> selected <?php endif; ?>><?php echo e(__('Select List Field')); ?></option>
												<option value="checkbox" <?php if($value['input'] == 'checkbox'): ?> selected <?php endif; ?>><?php echo e(__('Checkbox List Field')); ?></option>
												<option value="radio" <?php if($value['input'] == 'radio'): ?> selected <?php endif; ?>><?php echo e(__('Radio Buttons Field')); ?></option>
											</select>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-md-12 col-sm-12 text-center mb-2">
								<a href="<?php echo e(route('user.templates.custom')); ?>" class="btn btn-cancel mr-2"><?php echo e(__('Return')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/templates/custom/edit.blade.php ENDPATH**/ ?>