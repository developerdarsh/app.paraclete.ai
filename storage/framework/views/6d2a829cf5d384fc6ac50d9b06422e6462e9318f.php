	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			...
			<ol class="breadcrumb mb-2">
				<li class="breadcrumb-item"><a href="<?php echo e(route('user.dashboard')); ?>"><?php echo e(__('AI Panel')); ?></a></li>
				...
				<div class="card-body pt-5 pb-5 pl-6 pr-6">
					<div class="row text-center mb-4">
						<div class="col-lg col-md-6 col-sm-6 dashboard-border-right mt-auto mb-auto">
							<h6 class="fs-14 mt-3 font-weight-bold"><?php echo e(App\Services\HelperService::mainPlanModel()); ?> <?php echo e(__('Words Left')); ?></h6>
						...
						<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber|admin')): ?>
							<?php if(config('settings.image_feature_user') == 'allow'): ?>
								<div class="col-lg col-md-6 col-sm-6 dashboard-border-right mt-auto mb-auto">
									<h6 class="fs-14 mt-3 font-weight-bold"><?php echo e(__('DE/SD Images Left')); ?></h6>
						...
						<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber|admin')): ?>
							<?php if(config('settings.voiceover_feature_user') == 'allow'): ?>				
								<div class="col-lg col-md-6 col-sm-6 dashboard-border-right mt-auto mb-auto">
									<h6 class="fs-14 mt-3 font-weight-bold"><?php echo e(__('Characters Left')); ?></h6>
						...
						<?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber|admin')): ?>
							<?php if(config('settings.whisper_feature_user') == 'allow'): ?>
								<div class="col-lg col-md-6 col-sm-6 mt-auto mb-auto">
									<h6 class="fs-14 mt-3 font-weight-bold"><?php echo e(__('Minutes Left')); ?></h6>
				...
				<?php if(config('settings.user_support') == 'enabled'): ?>
					<div class="col-lg-2 col-md-2 col-sm-12 mt-5">                        
						<div class="title text-center dashboard-title">
							<h3 class="page-title"><?php echo e(__('Need Help?')); ?></h3>     
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/dashboard/index.blade.php ENDPATH**/ ?>