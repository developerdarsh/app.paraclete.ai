					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-20 super-strong"><?php echo e(__($template->name)); ?> 										
										<?php if($template->package == 'professional'): ?> 
											<span class="fs-8 btn btn-pro ml-2"><i class="   fa-solid fa-crown mr-2"></i><?php echo e(__('Pro')); ?> </span> 
										<?php elseif($template->package == 'free'): ?>
											<span class="fs-8 btn btn-free ml-2"><i class="   fa-solid fa-gift mr-2"></i><?php echo e(__('Free')); ?> </span> 
										<?php elseif($template->package == 'premium'): ?>
											<span class="fs-8 btn btn-yellow ml-2"><i class="   fa-solid fa-gem mr-2"></i><?php echo e(__('Premium')); ?> </span> 
										<?php elseif($template->new): ?>
											<span class="fs-8 btn btn-new ml-2"><i class="   fa-solid fa-sparkles mr-2"></i><?php echo e(__('New')); ?></span>
										<?php endif; ?>	
									</h6>
								</div>
								<div>
						...
						<?php if($brand_feature): ?>
							...
							<div class="col-sm-12 brand-details">
								<div class="form-group mb-5">	
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Select Company')); ?></h6>								
							...
							<div class="col-sm-12 brand-details">
								<div class="form-group mb-5">
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Select Product / Service')); ?> </h6>
...
unset($__errorArgs, $__bag); ?>	
						...
						<?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-sm-12">								
								<div class="input-box">	
									<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__($value['name'])); ?> <?php if($value['code'] == 'keywords'): ?> <span class="text-muted font-weight-normal">(<?php echo e(__('comma seperated')); ?>)</span> <?php endif; ?> <?php if($value['required']): ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span> <?php endif; ?></h6>									
						...
						<div class="col-sm-12">
							<div class="form-group">	
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('AI Model')); ?></h6>								
...
<?php endif; ?>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div id="form-group" class="mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Creativity')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Increase or decrease the creativity level to get various results')); ?>"></i></h6>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div id="form-group" class="mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Tone of Voice')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Set result tone of the text as needed')); ?>"></i></h6>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							<div class="input-box mb-0 mt-5">
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Number of Results')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Maximum supported results is 50')); ?>"></i></h6>
								<div class="form-group">
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-lg-6 col-md-12 col-sm-12">								
							<div class="input-box mt-5">								
								<h6 class="fs-11 text-muted mb-2 font-weight-semibold"><?php echo e(__('Estimated Result Length')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Estimated words length for each generated text result')); ?>"></i></h6>
								<div class="form-group">							    
...
unset($__errorArgs, $__bag); ?>
		...
		<div class="col-xl-7 col-lg-6 col-md-12 col-sm-12 mt-5-7">
								...
								<div class="template-action-buttons">
									<div class="btn-group w-100">
										...
										<div class="dropdown-menu" aria-labelledby="export" data-popper-placement="bottom-start">								
											...
											<a class="dropdown-item" id="export-word" onclick="exportWordEditor();"><i class="   fa-solid fa-file-word fs-13 text-muted mr-2"></i><?php echo e(__('MS Word')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/templates/original-template.blade.php ENDPATH**/ ?>