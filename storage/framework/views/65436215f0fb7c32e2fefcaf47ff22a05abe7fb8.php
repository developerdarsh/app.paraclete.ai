								...
								<div id="chat-container">
									<div class="msg left-msg">
										...
										<div class="message-bubble">					
											<div class="msg-text"><?php if(!is_null($chat->description)): ?> <?php echo __($chat->description); ?> <?php else: ?> <?php echo e(__('Hi there! How can I help you today?')); ?> <?php endif; ?></div>
										</div>
									</div>
				...
				success: function (data) {
					...
					if (data['status'] == 'success') {
						...
						$('.chat-sidebar-messages').prepend(`<div class="chat-sidebar-message selected-message" id=${data['id']}>
								...
								<div class="chat-actions d-flex">
									<a href="#" class="chat-edit fs-12" id="${data['id']}"><i class="  fa-solid fa-pen-to-square" data-tippy-content="<?php echo e(__('Edit Name')); ?>"></i></a>
									<a href="#" class="chat-delete fs-12 ml-2"  id="${data['id']}"><i class="  fa-solid fa-trash" data-tippy-content="<?php echo e(__('Delete Chat')); ?>"></i></a>
								</div>
							</div>`);
						active_id = data['id'];	
					} else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/chat/view-custom.blade.php ENDPATH**/ ?>