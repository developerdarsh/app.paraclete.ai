	...
	<div class="row" id="image-side-space">
		<div class="row no-gutters justify-content-center">
			<div class="col-lg-9 col-md-11 col-sm-12 text-center">
				...
				<h3 class="page-title mb-2"><?php echo e(__('AI Image Generator')); ?></h3>
					...
					<div class="mr-4">
						<p class="fs-11 text-muted pl-3"><i class="   fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> 
							<span class="font-weight-semibold">
								...
								<?php else: ?> 
									<span id="balance-number"><?php echo e(number_format(auth()->user()->images + auth()->user()->images_prepaid)); ?> </span> <?php echo e(__(' Image Credits')); ?>
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">		
								...
								<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if(trim($vendor) == 'sd'): ?>
										...
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3-large" name="<?php echo e(__('Stable Diffusion 3 Large')); ?>" icon="<i class='fa-solid fa-eye'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3 Large')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_large); ?> <?php if($credits->sd_3_large == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3-large-turbo" name="<?php echo e(__('Stable Diffusion 3 Large Turbo')); ?>" icon="<i class='fa-solid fa-image-slash'></i>">							
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3 Large Turbo')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_large_turbo); ?> <?php if($credits->sd_3_large_turbo == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3-medium" name="<?php echo e(__('Stable Diffusion 3 Medium')); ?>" icon="<i class='fa-solid fa-pen-clip'></i>">				
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3 Medium')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_medium); ?> <?php if($credits->sd_3_medium == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
...
console.log(vendor)
	...
	function setResolution() {
		...
		if (active_model == 'dall-e-2') {	
			...
			vendor = 'sd';
			sdReset();
		} else if (active_model == 'sd3-medium' || active_model == 'sd3-large' || active_model == 'sd3-large-turbo' || active_model == 'core' || active_model == 'ultra') {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/images/index.blade.php ENDPATH**/ ?>