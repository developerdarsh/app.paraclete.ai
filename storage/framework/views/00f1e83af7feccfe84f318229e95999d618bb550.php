...
<form id="wizard-form" action="" method="post" enctype="multipart/form-data" class="mt-24"> 		
	...
	<div class="row justify-content-center">	
		<div class="col-sm-12 text-center">
			<h3 class="card-title fs-20 mb-0 super-strong"><i class="fa-solid   fa-sparkles mr-2 text-primary"></i><?php echo e(__('AI Article Wizard')); ?></h3>
										...
										<select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Select input language')); ?>">		
											<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if(!is_null($wizard['language'])): ?>
													<option value="<?php echo e($language->language_code); ?>" data-img="<?php echo e(theme_url($language->language_flag)); ?>" <?php if($wizard['language'] == $language->language): ?> selected <?php endif; ?>> <?php echo e(__($language->language)); ?></option>
												<?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/templates/wizard/index.blade.php ENDPATH**/ ?>