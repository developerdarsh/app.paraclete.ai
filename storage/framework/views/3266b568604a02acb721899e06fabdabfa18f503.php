	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#allNotificationsTable').DataTable({
				...
				"order": [[ 1, "desc" ]],
				language: {
					"emptyTable": "<div><img id='no-results-img' src='<?php echo e(theme_url('img/files/no-notification.png')); ?>'><br><?php echo e(__('You have not created any mass notifications yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/admin/notification/index.blade.php ENDPATH**/ ?>