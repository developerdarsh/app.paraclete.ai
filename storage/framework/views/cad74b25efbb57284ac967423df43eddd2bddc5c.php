								...
								<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>					
									...
									<?php $__currentLoopData = $favorite_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($template->group == $category->code): ?>
											<div class="col-lg-3 col-md-6 col-sm-12 pl-1 pr-1 template-item-wrapper">
												<div class="template">
													<a id="<?php echo e($template->template_code); ?>" onclick="favoriteStatus(this.id)"><i id="<?php echo e($template->template_code); ?>-icon" class="<?php if($template->favorite): ?> fa-solid fa-stars <?php else: ?> fa-regular fa-star <?php endif; ?> star"></i></a>
													<div class="card <?php if($template->package == 'professional'): ?> professional <?php elseif($template->package == 'premium'): ?> premium <?php elseif($template->favorite): ?> favorite <?php else: ?>   <?php endif; ?>" id="<?php echo e($template->template_code); ?>-card" onclick="window.location.href='<?php echo e(url('app/user/templates/original-template')); ?>/<?php echo e($template->slug); ?>'">
														<div class="card-body pt-5">
															...
															<div class="template-category">
																<p class="fs-9 btn btn-category mb-0"><?php echo e(__($category->name)); ?></p>
																<div class="template-package-info">
																	<?php if($template->package == 'professional'): ?> 
																		<p class="fs-8 btn btn-pro mb-0"><i class="fa-solid fa-crown mr-2"></i><?php echo e(__('Pro')); ?></p>
																		<?php if($template->new): ?>
																			<p class="fs-8 btn btn-new mb-0 btn-new-pro"><i class="fa-solid fa-sparkles mr-2"></i><?php echo e(__('New')); ?></p>
																		<?php endif; ?>
																	<?php elseif($template->package == 'free'): ?>
																		<p class="fs-8 btn btn-free mb-0"><i class="fa-solid fa-gift mr-2"></i><?php echo e(__('Free')); ?></p>
																		<?php if($template->new): ?>
																			<p class="fs-8 btn btn-new mb-0 btn-new-free"><i class="fa-solid fa-sparkles mr-2"></i><?php echo e(__('New')); ?></p>
																		<?php endif; ?>
																	<?php elseif($template->package == 'premium'): ?>
																		<p class="fs-8 btn btn-yellow mb-0"><i class="fa-solid fa-gem mr-2"></i><?php echo e(__('Premium')); ?></p>
																		<?php if($template->new): ?>
																			<p class="fs-8 btn btn-new mb-0 btn-new-premium"><i class="fa-solid fa-sparkles mr-2"></i><?php echo e(__('New')); ?></p>
																		<?php endif; ?>
																	<?php elseif($template->new): ?>
																		<p class="fs-8 btn btn-new mb-0"><i class="fa-solid fa-sparkles mr-2"></i><?php echo e(__('New')); ?></p>
																	<?php endif; ?>
																</div>
															</div>
														</div>
									...
									<?php $__currentLoopData = $favorite_custom_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($template->group == $category->code): ?>
											<div class="col-lg-3 col-md-6 col-sm-12 pl-1 pr-1 template-item-wrapper">
												<div class="template">
													<a id="<?php echo e($template->template_code); ?>" onclick="favoriteStatusCustom(this.id)"><i id="<?php echo e($template->template_code); ?>-icon" class="<?php if($template->favorite): ?> fa-solid fa-stars <?php else: ?> fa-regular fa-star <?php endif; ?> star"></i></a>
													<div class="card <?php if($template->package == 'professional'): ?> professional <?php elseif($template->package == 'premium'): ?> premium <?php elseif($template->favorite): ?> favorite <?php else: ?>   <?php endif; ?>" id="<?php echo e($template->template_code); ?>-card" onclick="window.location.href='<?php echo e(url('app/user/templates')); ?>/<?php echo e($template->slug); ?>/<?php echo e($template->template_code); ?>'">
														<div class="card-body pt-5">
															<div class="template-icon mb-4">
																<?php echo $template->icon; ?>												
															</div>
 		...
 		<div class="modal-dialog modal-dialog-centered modal-xl">
 			<div class="modal-content">
 				...
 				<div class="modal-body">
 					<div class="row">
 						<!--ARCADE EMBED START-->
 							<div style="position: relative; padding-bottom: calc(56.25% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/yM2D11k9RszxTPWEIAEr?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="Paraclete AI Templates" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>
 						<!--ARCADE EMBED END-->
 					</div>
 				</div>
 			</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/templates/index.blade.php ENDPATH**/ ?>