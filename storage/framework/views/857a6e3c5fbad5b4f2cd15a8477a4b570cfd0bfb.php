		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">				
				<div class="card-body pt-5">
					<form class="w-100" action="<?php echo e(route('user.templates.custom.store')); ?>" method="POST" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						<div class="row">	
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-md-12 col-sm-12 text-center mb-2">
								<a href="<?php echo e(route('user.templates')); ?>" class="btn btn-cancel"><?php echo e(__('Return')); ?></a>
								<button type="submit" class="btn btn-primary pl-6 pr-6"><?php echo e(__('Create')); ?></button>	
							</div>	
		...
		<div class="col-lg-10 col-md-12 col-sm-12 mt-4">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('My Custom Templates List')); ?></h3>
				</div>
				<div class="card-body pt-2">
					...
					<table id='allTemplates' class='table' width='100%'>
						<thead>
							<tr>							
								<th width="8%"><?php echo e(__('Template Name')); ?></th>
								<th width="12%"><?php echo e(__('Template Description')); ?></th>	
	...
	<script type="text/javascript">
		$(function () {
			...
			let table = $('#allTemplates').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('user.templates.custom')); ?>",
				columns: [					
					{
						data: 'custom-name',
						name: 'custom-name',
		...
		function notifyUser(input) {
			...
			switch (input.value) {
				case 'input':
				case 'textarea':
					placeholder.setAttribute('placeholder', '<?php echo e(__('Enter Input Field Description (Required)')); ?>');
					break;
				case 'select':
					placeholder.setAttribute('placeholder', '<?php echo e(__('Enter Comma separated Options for Select List (Required)')); ?>');
					break;
				case 'checkbox':
					placeholder.setAttribute('placeholder', '<?php echo e(__('Enter Comma separated Values for Checkboxes (Required)')); ?>');
					break;
				case 'radio':
					placeholder.setAttribute('placeholder', '<?php echo e(__('Enter Comma separated Values for Radio Buttons (Required)')); ?>');
					break;
				default:
					placeholder.setAttribute('placeholder', '<?php echo e(__('Enter Input Field Description (Required)')); ?>');
					break;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/templates/custom/index.blade.php ENDPATH**/ ?>