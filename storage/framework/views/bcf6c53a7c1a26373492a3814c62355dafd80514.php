	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">	
			...
			<div class="col-sm-12 text-center">
				<h3 class="page-title mb-2"><?php echo e(__('AI Vision')); ?></h3>
				<h6 class="fs-12 text-muted"><?php echo e(__($chat->description)); ?></h6>
				<div class="mb-6">
 				...
 				<div class="modal-body">
 					<div class="row">
 						<div style="position: relative; padding-bottom: calc(46.925329428989755% + 41px); height: 0; width: 100%">
 							<!--ARCADE EMBED START-->
 								<div style="position: relative; padding-bottom: calc(56.25% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/zaIBXSqdqzHqFETs8FMv?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="AI Vision" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>
 							<!--ARCADE EMBED END-->						
 						</div>
 					</div>
 				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/vision/index.blade.php ENDPATH**/ ?>