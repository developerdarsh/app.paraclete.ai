...
<div class="page-header mt-5-7 justify-content-center">
	<div class="page-leftheader text-center">
		...
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.davinci.chats')); ?>"> <?php echo e(__('Chat Settings')); ?></a></li>
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('All Custom Chat Assistants')); ?></h3>
					<a href="<?php echo e(route('admin.chat.assistant.create')); ?>" id="createButton" class="btn btn-primary text-right ripple right"><?php echo e(__('Create New Chat Assistant')); ?></a>
				</div>
					...
					<table id='allTemplates' class='table' width='100%'>
						<thead>
							<tr>							
								...
								<th width="2%"><?php echo e(__('Group')); ?></th>
								<th width="2%"><?php echo e(__('Package')); ?></th>							
								<th width="2%"><?php echo e(__('Updated On')); ?></th>	    										 						           	
	...
	<script type="text/javascript">
		$(function () {
			...
			let table = $('#allTemplates').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('admin.chat.assistant')); ?>",
				columns: [					
					{
						data: 'custom-avatar',
						name: 'custom-avatar',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/davinci/chats/assistant/index.blade.php ENDPATH**/ ?>