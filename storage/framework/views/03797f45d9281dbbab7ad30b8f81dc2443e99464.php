    ...
    <div class="topview-content">
        ...
        <div class="ai-tools-section">
            ...
            <div class="tools-slider">
                <a href="<?php echo e(route('avatars.create')); ?>" class="tool-card">
                ...
                <a href="<?php echo e(route('avatars.video.creation')); ?>" class="tool-card">
                    <div class="tool-preview">
                 ...
                 <a href="<?php echo e(route('avatars.product.templete')); ?>" class="tool-card">
                    <div class="tool-preview">
                ...
                <a href="<?php echo e(route('avatars.anyshoot.templete')); ?>" class="tool-card">
    ...
    <!-- Video Avatar Templates End -->
     <div class="templates-section">
            <div class="templates-header">
                ...
                <a href="<?php echo e(route('avatars.video.creation')); ?>" class="view-all">View All</a>

            </div>
            
            <div class="templates-slider" id="videoavatar-carousel">
                <?php $__currentLoopData = array_slice($video_avatars['result']['data'], 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video_avatar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#" class="template-card">
                        <div class="template-preview">
                            <img src="<?php echo e($video_avatar['coverUrl']); ?>" alt="Template Preview" />
                        </div>
                        <div class="template-info">
                            <p><?php echo e($video_avatar['ethnicities'][0]['ethnicityName'] ?? 'Unknown Ethnicity'); ?></p>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/topview/index.blade.php ENDPATH**/ ?>