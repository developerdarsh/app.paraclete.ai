					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-2 ml-3 fs-16 number-font"><?php echo e(__('AI Youtube')); ?></h6>
								</div>									
							</div>								
							<div class="template-info">
								<p class="fs-12 text-muted mb-4"><?php echo e(__('Turn your Youtube videos into Blog posts')); ?></p>
							</div>
						</div>
					</div>
...
<?php endif; ?>
						...
						<div class="col-sm-12">
							<div class="input-box">	
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Youtube Video URL')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>									
								<div class="form-group relative">						    
									<input class="form-control" id="url" name="url" placeholder="<?php echo e(__('Enter Youtube URL')); ?>" required />
								</div> 
							</div> 
						</div>
						...
						<div class="col-sm-12 mb-5">
							<div id="form-group">
								<h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Action')); ?></h6>
								<select id="action" name="action" class="form-select">
									<option value="post"><?php echo e(__('Create a blog post')); ?></option>																																							
									<option value="outline"><?php echo e(__('Create outlines')); ?></option>
									<option value="explain"><?php echo e(__('Explain main idea')); ?></option>
									<option value="description"><?php echo e(__('Create expanded description')); ?></option>
									<option value="summarize"><?php echo e(__('Summarize the content')); ?></option>
									<option value="compare"><?php echo e(__('Prepare pros and cons')); ?></option>
								</select>
							</div>
						</div>
 			...
 			<div class="modal-body">
 				<div class="row">
 					<div style="position: relative; padding-bottom: calc(46.925329428989755% + 41px); height: 0; width: 100%">
 						<!--ARCADE EMBED START-->
 							<div style="position: relative; padding-bottom: calc(56.25% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/1n9cIFhNbrfbaOvHKM9d?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="AI Youtube" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div>
 						<!--ARCADE EMBED END-->						
 					</div>
 				</div>
 			</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$('#youtube-form').on('submit', function(e) {
			...
			let check = '<?php echo e($settings->youtube_api); ?>';
			console.log(check)

			if (check == null || check == '') {
				toastr.warning('<?php echo e(__('Please provide Youtube API key first')); ?>');
				return;
			}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/youtube/index.blade.php ENDPATH**/ ?>