					...
					<div class="row">
						<div class="col-sm-12">
							<div class="text-left mb-5" id="balance-status">
								<span class="fs-11 text-muted pl-3"><i class="   fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->minutes == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->minutes + auth()->user()->minutes_prepaid)); ?> <?php echo e(__('Minutes')); ?> <?php endif; ?></span></span>
							</div>							
						</div>	
						<div class="col-sm-12">								
							<!-- DRAG & DROP FILES -->
						...
						<div class="col-sm-12">
							<div class="form-group">	
								...
								<select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Specify Audio language')); ?>">
									...
									<option value="af" data-img="<?php echo e(theme_url('img/flags/za.svg')); ?>"> <?php echo e(__('Afrikaans')); ?></option>							
									<option value="ar" data-img="<?php echo e(theme_url('img/flags/ae.svg')); ?>"> <?php echo e(__('Arabic')); ?></option>							
									<option value="hy" data-img="<?php echo e(theme_url('img/flags/am.svg')); ?>"> <?php echo e(__('Armenian')); ?></option>							
									<option value="az" data-img="<?php echo e(theme_url('img/flags/az.svg')); ?>"> <?php echo e(__('Azerbaijani')); ?></option>							
									<option value="be" data-img="<?php echo e(theme_url('img/flags/by.svg')); ?>"> <?php echo e(__('Belarusian')); ?></option>							
									<option value="bs" data-img="<?php echo e(theme_url('img/flags/ba.svg')); ?>"> <?php echo e(__('Bosnian')); ?></option>							
									<option value="bg" data-img="<?php echo e(theme_url('img/flags/bg.svg')); ?>"> <?php echo e(__('Bulgarian')); ?></option>							
									<option value="ca" data-img="<?php echo e(theme_url('img/flags/es.svg')); ?>"> <?php echo e(__('Catalan')); ?></option>							
									<option value="zh" data-img="<?php echo e(theme_url('img/flags/cn.svg')); ?>"> <?php echo e(__('Chinese')); ?></option>							
									<option value="hr" data-img="<?php echo e(theme_url('img/flags/hr.svg')); ?>"> <?php echo e(__('Croatian')); ?></option>							
									<option value="cs" data-img="<?php echo e(theme_url('img/flags/cz.svg')); ?>"> <?php echo e(__('Czech')); ?></option>							
									<option value="da" data-img="<?php echo e(theme_url('img/flags/dk.svg')); ?>"> <?php echo e(__('Danish')); ?></option>							
									<option value="nl" data-img="<?php echo e(theme_url('img/flags/nl.svg')); ?>"> <?php echo e(__('Dutch')); ?></option>							
									<option value="en" data-img="<?php echo e(theme_url('img/flags/us.svg')); ?>"> <?php echo e(__('English')); ?></option>							
									<option value="et" data-img="<?php echo e(theme_url('img/flags/ee.svg')); ?>"> <?php echo e(__('Estonian')); ?></option>							
									<option value="fi" data-img="<?php echo e(theme_url('img/flags/fi.svg')); ?>"> <?php echo e(__('Finnish')); ?></option>							
									<option value="fr" data-img="<?php echo e(theme_url('img/flags/fr.svg')); ?>"> <?php echo e(__('French')); ?></option>							
									<option value="gl" data-img="<?php echo e(theme_url('img/flags/es.svg')); ?>"> <?php echo e(__('Galician')); ?></option>							
									<option value="de" data-img="<?php echo e(theme_url('img/flags/de.svg')); ?>"> <?php echo e(__('German')); ?></option>							
									<option value="el" data-img="<?php echo e(theme_url('img/flags/gr.svg')); ?>"> <?php echo e(__('Greek')); ?></option>							
									<option value="he" data-img="<?php echo e(theme_url('img/flags/il.svg')); ?>"> <?php echo e(__('Hebrew')); ?></option>							
									<option value="hi" data-img="<?php echo e(theme_url('img/flags/in.svg')); ?>"> <?php echo e(__('Hindi')); ?></option>							
									<option value="hu" data-img="<?php echo e(theme_url('img/flags/hu.svg')); ?>"> <?php echo e(__('Hungarian')); ?></option>							
									<option value="is" data-img="<?php echo e(theme_url('img/flags/is.svg')); ?>"> <?php echo e(__('Icelandic')); ?></option>							
									<option value="id" data-img="<?php echo e(theme_url('img/flags/id.svg')); ?>"> <?php echo e(__('Indonesian')); ?></option>							
									<option value="it" data-img="<?php echo e(theme_url('img/flags/it.svg')); ?>"> <?php echo e(__('Italian')); ?></option>							
									<option value="ja" data-img="<?php echo e(theme_url('img/flags/jp.svg')); ?>"> <?php echo e(__('Japanese')); ?></option>							
									<option value="kn" data-img="<?php echo e(theme_url('img/flags/in.svg')); ?>"> <?php echo e(__('Kannada')); ?></option>							
									<option value="kk" data-img="<?php echo e(theme_url('img/flags/kz.svg')); ?>"> <?php echo e(__('Kazakh')); ?></option>							
									<option value="ko" data-img="<?php echo e(theme_url('img/flags/kr.svg')); ?>"> <?php echo e(__('Korean')); ?></option>							
									<option value="lv" data-img="<?php echo e(theme_url('img/flags/lv.svg')); ?>"> <?php echo e(__('Latvian')); ?></option>							
									<option value="lt" data-img="<?php echo e(theme_url('img/flags/lt.svg')); ?>"> <?php echo e(__('Lithuanian')); ?></option>							
									<option value="mk" data-img="<?php echo e(theme_url('img/flags/mk.svg')); ?>"> <?php echo e(__('Macedonian')); ?></option>							
									<option value="ms" data-img="<?php echo e(theme_url('img/flags/my.svg')); ?>"> <?php echo e(__('Malay')); ?></option>							
									<option value="mr" data-img="<?php echo e(theme_url('img/flags/in.svg')); ?>"> <?php echo e(__('Marathi')); ?></option>							
									<option value="mi" data-img="<?php echo e(theme_url('img/flags/nz.svg')); ?>"> <?php echo e(__('Maori')); ?></option>							
									<option value="ne" data-img="<?php echo e(theme_url('img/flags/np.svg')); ?>"> <?php echo e(__('Nepali')); ?></option>							
									<option value="no" data-img="<?php echo e(theme_url('img/flags/no.svg')); ?>"> <?php echo e(__('Norwegian')); ?></option>							
									<option value="fa" data-img="<?php echo e(theme_url('img/flags/ir.svg')); ?>"> <?php echo e(__('Persian')); ?></option>							
									<option value="pl" data-img="<?php echo e(theme_url('img/flags/pl.svg')); ?>"> <?php echo e(__('Polish')); ?></option>							
									<option value="pt" data-img="<?php echo e(theme_url('img/flags/pt.svg')); ?>"> <?php echo e(__('Portuguese')); ?></option>							
									<option value="ro" data-img="<?php echo e(theme_url('img/flags/ro.svg')); ?>"> <?php echo e(__('Romanian')); ?></option>							
									<option value="ru" data-img="<?php echo e(theme_url('img/flags/ru.svg')); ?>"> <?php echo e(__('Russian')); ?></option>							
									<option value="sr" data-img="<?php echo e(theme_url('img/flags/rs.svg')); ?>"> <?php echo e(__('Serbian')); ?></option>							
									<option value="sk" data-img="<?php echo e(theme_url('img/flags/sk.svg')); ?>"> <?php echo e(__('Slovak')); ?></option>							
									<option value="sl" data-img="<?php echo e(theme_url('img/flags/si.svg')); ?>"> <?php echo e(__('Slovenian')); ?></option>							
									<option value="es" data-img="<?php echo e(theme_url('img/flags/es.svg')); ?>"> <?php echo e(__('Spanish')); ?></option>							
									<option value="sw" data-img="<?php echo e(theme_url('img/flags/ke.svg')); ?>"> <?php echo e(__('Swahili')); ?></option>							
									<option value="sv" data-img="<?php echo e(theme_url('img/flags/se.svg')); ?>"> <?php echo e(__('Swedish')); ?></option>							
									<option value="tl" data-img="<?php echo e(theme_url('img/flags/ph.svg')); ?>"> <?php echo e(__('Tagalog')); ?></option>							
									<option value="ta" data-img="<?php echo e(theme_url('img/flags/in.svg')); ?>"> <?php echo e(__('Tamil')); ?></option>							
									<option value="th" data-img="<?php echo e(theme_url('img/flags/th.svg')); ?>"> <?php echo e(__('Thai')); ?></option>							
									<option value="tr" data-img="<?php echo e(theme_url('img/flags/tr.svg')); ?>"> <?php echo e(__('Turkish')); ?></option>							
									<option value="uk" data-img="<?php echo e(theme_url('img/flags/ua.svg')); ?>"> <?php echo e(__('Ukrainian')); ?></option>							
									<option value="ur" data-img="<?php echo e(theme_url('img/flags/in.svg')); ?>"> <?php echo e(__('Urdu')); ?></option>							
									<option value="vi" data-img="<?php echo e(theme_url('img/flags/vn.svg')); ?>"> <?php echo e(__('Vietnamese')); ?></option>							
									<option value="cy" data-img="<?php echo e(theme_url('img/flags/gb-wls.svg')); ?>"> <?php echo e(__('Welsh')); ?></option>							
								</select>
...
<script src="<?php echo e(theme_url('js/wavesurfer.min.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/transcribe/index.blade.php ENDPATH**/ ?>