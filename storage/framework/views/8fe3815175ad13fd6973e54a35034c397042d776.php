					...
					<div class="row">
						<div class="col-lg-2 col-md-3 col-sm-12">
							...
							<ul class="avatar-menu">								
								...
								<li class="slide">
									<a class="side-menu__item active" href="<?php echo e(route('user.extension.avatar.list.videos')); ?>">
							...
							<div class="">
								<div class="row p-4">
									<?php $__currentLoopData = $avatars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $avatar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $__currentLoopData = $avatar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $character): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										 	<?php if($loop->first): ?>
											 <div class="col-md-2 col-sm-6">
												<div class="card avatar-card mb-6" onclick="window.location.href='<?php echo e(route('user.extension.avatar.list.videos.view', $character->group)); ?>'">
													<div class="avatar-card-box">
														<div class="avatar-image-box">
															<img src="<?php echo e($character->preview_image_url); ?>" class="avatar-image">												
														</div>
														<div class="avatar-info text-center pt-4 pb-4">
															<p class="mb-0 fs-12"><?php echo e(ucfirst($character->group)); ?></p>
															<p class="mb-0 fs-11 text-muted"><?php echo e(count($avatar)); ?> <?php echo e(__('looks')); ?></p>
														</div>
													</div>							
												</div>
											</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/avatar/video-avatars.blade.php ENDPATH**/ ?>