										...
										<select id="language" name="language" class="form-select" data-placeholder="<?php echo e(__('Select input language')); ?>">		
											<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if(!is_null($wizard['language'])): ?>
													<option value="<?php echo e($language->language_code); ?>" data-img="<?php echo e(theme_url($language->language_flag)); ?>" <?php if($wizard['language'] == $language->language): ?> selected <?php endif; ?>> <?php echo e($language->language); ?></option>
												<?php else: ?>
...
unset($__errorArgs, $__bag); ?>	
			...
			<div class="col-lg-7 col-md-12 col-sm-12 pl-5" id="wizard-results-wrapper">
				<div class="row">
					<div class="col-sm-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/templates/wizard/index.blade.php ENDPATH**/ ?>