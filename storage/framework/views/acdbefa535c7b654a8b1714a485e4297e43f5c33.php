...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0"><?php echo e(__('Original Chatbots')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> <?php echo e(__('Original Chatbots')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('All Original Chatbots')); ?></h3>
				</div>
							...
							<table id='allResultsTable' class='table' width='100%'>
									<thead>
										<tr>												
											...
											<th width="6%"><?php echo e(__('Name')); ?></th> 
											<th width="8%"><?php echo e(__('Role')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/davinci/chats/index.blade.php ENDPATH**/ ?>