							...
							<div class="border-0 templates-nav-header">
								<div class="card-body">
									<div class="text-center">
										<h3 class="card-title mb-3 ml-2 fs-20 font-weight-bold"><?php echo e(__('Marketplace')); ?></h3>										
													...
													<div class="card-body">
														<div class="theme-icon mb-3">
															<div><?php echo $extension['banner']; ?> 
																...
																<?php if($extension['is_new']): ?>
																	<span class="new-available-extension"><?php echo e(__('New')); ?></span>
																<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/admin/marketplace/index.blade.php ENDPATH**/ ?>