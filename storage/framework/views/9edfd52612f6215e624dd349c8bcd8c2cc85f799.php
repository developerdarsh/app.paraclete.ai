...
<?php $__env->startSection('content'); ?>					
	<div class="row justify-content-center mt-24">
		<div class="col-sm-12 text-center">
			<h3 class="card-title fs-20 mb-3 super-strong"><?php echo e(__('AI Settings')); ?></h3>
									...
									<div class="card shadow-0 mb-6" onclick="window.location.href='<?php echo e(url('/app/admin/davinci/configs/api/openai')); ?>'">
										<div class="card-body p-5 d-flex">
											...
											<div class="extension-title">
												...
												<p class="fs-12 mb-0 text-muted"><?php echo e(__('AI Writer | Article Wizard | Smart Editor | AI Images | AI Chat | AI Code')); ?></p>
											</div>
										</div>							
									</div>
								</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-12">
												<div class="input-box">	
													...
													<select id="default-model-user-template" name="default-model-user-template" class="form-select">	
														...
														<option value="o3-mini" <?php if( config('settings.default_model_user_template')  == 'o3-mini'): ?> selected <?php endif; ?>><?php echo e(__('o3 mini')); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/admin/davinci/configuration/index.blade.php ENDPATH**/ ?>