		...
		<div class="col-lg-10 col-md-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					...
					<a href="<?php echo e(route('user.brand.create')); ?>" class="btn btn-primary ripple" style="margin-left: auto; text-transform: none"><?php echo e(__('Add New Brand')); ?></a>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/brand/index.blade.php ENDPATH**/ ?>