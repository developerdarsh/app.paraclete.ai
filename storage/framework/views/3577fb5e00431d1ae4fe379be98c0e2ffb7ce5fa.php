					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-2 ml-3 fs-16 number-font"><?php echo e(__('AI RSS')); ?></h6>
								</div>									
							</div>								
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/rss/index.blade.php ENDPATH**/ ?>