    ...
    <div class="container-fluid"> 
        <div class="d-flex">            
            ...
            <a class="header-brand w-100 text-center" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(theme_url('img/brand/logo.png')); ?>" class="header-brand-img desktop-lgo w-10 pt-2" alt="Polly logo">
                <img src="<?php echo e(theme_url('img/brand/favicon.png')); ?>" class="header-brand-img mobile-logo" alt="Polly logo">
            </a>
...
<!-- END TOP MENU BAR -->
<?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/layouts/dashboard/nav-top-smart.blade.php ENDPATH**/ ?>