	...
	<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">		
		...
		<div class="row justify-content-md-center">
			<div class="col-sm-12 text-center">
				<h3 class="page-title mb-2"><?php echo e(__('AI Web Chat')); ?></h3>
				<h6 class="fs-12 text-muted"><?php echo e(__('Turn Your Website into Intelligent Dynamic Conversations')); ?></h6>
				<div class="mb-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/chat_web/index.blade.php ENDPATH**/ ?>