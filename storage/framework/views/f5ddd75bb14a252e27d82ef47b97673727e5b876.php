		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			...
			<div class="card border-0">
				<div class="card-header pt-4 border-0" id="voiceover-character-counter-top">
					<h3 class="page-title ml-5"><?php echo e(__('AI Voiceover Studio')); ?> </h3>
					<span class="fs-11 text-muted pl-3" id="voiceover-character-counter"><i class="   fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->available_chars == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->available_chars + auth()->user()->available_chars_prepaid)); ?> <?php echo e(__('Characters')); ?> <?php endif; ?></span></span>
				</div>
