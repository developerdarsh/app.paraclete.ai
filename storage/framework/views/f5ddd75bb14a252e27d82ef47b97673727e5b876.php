		...
		<div class="col-lg-12 col-md-12 col-xm-12">
			...
			<div class="card border-0">
				<div class="card-header pt-4 border-0" id="voiceover-character-counter-top">
					<h3 class="card-title"><i class="   fa-solid fa-waveform-lines mr-4 text-info"></i><?php echo e(__('AI Voiceover Studio')); ?> </h3>
					<span class="fs-11 text-muted pl-3" id="voiceover-character-counter"><i class="   fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> <span class="font-weight-semibold" id="balance-number"><?php if(auth()->user()->characters == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->characters + auth()->user()->characters_prepaid)); ?> <?php echo e(__('Characters')); ?> <?php endif; ?></span></span>
				</div>
				<div class="card-body pt-2 pl-7 pr-7 pb-4" id="tts-body-minify">
						...
						<form id="synthesize-text-form" action="<?php echo e(route('user.voiceover.synthesize')); ?>" listen="<?php echo e(route('user.voiceover.listen')); ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">									
										<select id="languages" name="language" class="form-select" data-placeholder="<?php echo e(__('Pick Your Language')); ?>:" data-callback="language_select">	
											<?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($language->language_code); ?>" data-img="<?php echo e(theme_url($language->language_flag)); ?>" <?php if(auth()->user()->default_voiceover_language == $language->language_code): ?> selected <?php endif; ?>> <?php echo e(__($language->language)); ?></option>
							...
							<div class="card-footer border-0 text-center mt-3">
								<span id="processing"><img src="<?php echo e(theme_url('img/svgs/processing.svg')); ?>" alt=""></span>
 	...
 	<div class="modal-dialog modal-dialog-centered modal-xl">
 		<div class="modal-content">
 			...
 			<div class="modal-body">
 				<div class="row">
 					<!--ARCADE EMBED START--><div style="position: relative; padding-bottom: calc(56.25% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/gV1Bjfd4UVJAuoSYt0N0?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" title="AI Voiceover Studio" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div><!--ARCADE EMBED END-->
 				</div>
 			</div>
 		</div>
 	</div>
...
<?php $__env->startSection('js'); ?>
	...
	<script src="<?php echo e(theme_url('js/dashboard.js')); ?>"></script>
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#resultTable').DataTable({
				...
				colReorder: true,
				language: {
					"emptyTable": "<div><img id='no-results-img' src='<?php echo e(theme_url('img/files/no-result.png')); ?>'><br><?php echo e(__('No synthesized text results yet')); ?></div>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/classic/user/voiceover/index.blade.php ENDPATH**/ ?>