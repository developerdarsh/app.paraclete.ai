		...
		<div class="row no-gutters justify-content-center">
			<div class="col-lg-9 col-md-11 col-sm-12 text-center">
				...
				<div class="card-top d-flex text-right justify-content-right right mx-auto">
					<div class="mr-4">
						<p class="fs-11 text-muted pl-3"><i class="   fa-solid fa-bolt-lightning mr-2 text-primary"></i><?php echo e(__('Your Balance is')); ?> 
							<span class="font-weight-semibold">
								<?php if(auth()->user()->images == -1): ?> 
									<span id="balance-number"><?php echo e(__('Unlimited')); ?></span>
								<?php else: ?> 
									<span id="balance-number"><?php echo e(number_format(auth()->user()->images + auth()->user()->images_prepaid)); ?> </span> <?php echo e(__('Media Credits')); ?>
				...
				<div class="card mb-4 border-0 image-prompt-wrapper">
					<div class="card-body p-0">					
						<div class="image-prompt d-flex">
							...
							<div>
								<button type="submit" name="submit" class="btn btn-primary w-100 pt-2 pb-2" id="image-generate"><i class="   fa-solid fa-wand-magic-sparkles mr-2"></i><?php echo e(__('Generate')); ?></button>
							</div>
						</div>					
					</div>
				</div>
		...
		<div class="image-settings p-4">
					...
					<div class="photo-studio-tools mb-5">
						<div class="nav-item dropdown w-100">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
								<h6 class="dropdown-item-title fs-13 font-weight-semibold" id="active-template-name"><?php echo e($model_name); ?></h6>	
							</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">		
								<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if(trim($vendor) == 'openai'): ?>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="dall-e-3-hd" name="<?php echo e(__('OpenAI DALLE 3 HD')); ?>" icon="<i class='fa-solid fa-aperture'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('OpenAI DALLE 3 HD')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->openai_dalle_3_hd); ?> <?php if($credits->openai_dalle_3_hd == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>	
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="dall-e-3" name="<?php echo e(__('OpenAI DALLE 3')); ?>" icon="<i class='   fa-solid fa-palette'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('OpenAI DALLE 3')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->openai_dalle_3); ?> <?php if($credits->openai_dalle_3 == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="dall-e-2" name="<?php echo e(__('OpenAI DALLE 2')); ?>" icon="<i class='fa-solid fa-droplet'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('OpenAI DALLE 2')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->openai_dalle_2); ?> <?php if($credits->openai_dalle_2 == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>								
								<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if(trim($vendor) == 'sd'): ?>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="ultra" name="<?php echo e(__('Stable Diffusion Ultra')); ?>" icon="<i class='fa-solid fa-hexagon-image'></i>">									
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion Ultra')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_ultra); ?> <?php if($credits->sd_ultra == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="core" name="<?php echo e(__('Stable Diffusion Core')); ?>" icon="<i class='fa-solid fa-images'></i>">		
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion Core')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_core); ?> <?php if($credits->sd_core == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3.5-large" name="<?php echo e(__('Stable Diffusion 3.5 Large')); ?>" icon="<i class='fa-solid fa-eye'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3.5 Large')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_large); ?> <?php if($credits->sd_3_large == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3.5-large-turbo" name="<?php echo e(__('Stable Diffusion 3.5 Large Turbo')); ?>" icon="<i class='fa-solid fa-image-slash'></i>">							
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3.5 Large Turbo')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_large_turbo); ?> <?php if($credits->sd_3_large_turbo == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="sd3.5-medium" name="<?php echo e(__('Stable Diffusion 3.5 Medium')); ?>" icon="<i class='fa-solid fa-pen-clip'></i>">				
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion 3.5 Medium')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_3_medium); ?> <?php if($credits->sd_3_medium == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="stable-diffusion-xl-1024-v1-0" name="<?php echo e(__('SDXL v1.0')); ?>" icon="<i class='fa-solid fa-camera-viewfinder'></i>">
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('SDXL v1.0')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_xl_v10); ?> <?php if($credits->sd_xl_v10 == 1): ?> <?php echo e(__('credit')); ?> <?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>
										<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="stable-diffusion-v1-6" name="<?php echo e(__('Stable Diffusion v1.6')); ?>" icon="<i class='   fa-solid fa-high-definition'></i>">						
											<h6 class="dropdown-item-title fs-12"><?php echo e(__('Stable Diffusion v1.6')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->sd_v16); ?> <?php if($credits->sd_v16 == 1): ?> <?php echo e(__('credit')); ?> <?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
										</a>	
									<?php endif; ?>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
								<?php if(App\Services\HelperService::extensionFlux()): ?>
									<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(trim($vendor) == 'falai'): ?>																				
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="flux-realism" name="<?php echo e(__('FLUX Realism')); ?>" icon="<i class='   fa-solid fa-high-definition'></i>">						
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('FLUX Realism')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->flux_realism); ?> <?php if($credits->flux_realism == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="flux-pro/new" name="<?php echo e(__('FLUX.1 [pro]')); ?>" icon="<i class='fa-solid fa-wand-magic-sparkles'></i>">	
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('FLUX.1 [pro]')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->flux_pro); ?> <?php if($credits->flux_pro == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="flux/schnell" name="<?php echo e(__('FLUX.1 [schnell]')); ?>" icon="<i class='fa-solid fa-wand-magic-sparkles'></i>">	
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('FLUX.1 [schnell]')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->flux_schnell); ?> <?php if($credits->flux_schnell == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="flux/dev" name="<?php echo e(__('FLUX.1 [dev]')); ?>" icon="<i class='fa-solid fa-wand-magic-sparkles'></i>">	
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('FLUX.1 [dev]')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->flux_dev); ?> <?php if($credits->flux_dev == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>										
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
								<?php if(App\Services\HelperService::extensionMidjourney()): ?>
									<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(trim($vendor) == 'midjourney'): ?>																				
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="midjourney/fast" name="<?php echo e(__('Midjourney Fast')); ?>" icon="<i class='   fa-solid fa-high-definition'></i>">						
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('Midjourney Fast')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->midjourney_fast); ?> <?php if($credits->midjourney_fast == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="midjourney/relax" name="<?php echo e(__('Midjourney Relax')); ?>" icon="<i class='fa-solid fa-wand-magic-sparkles'></i>">	
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('Midjourney Relax')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->midjourney_relax); ?> <?php if($credits->midjourney_relax == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="midjourney/turbo" name="<?php echo e(__('Midjourney Turbo')); ?>" icon="<i class='fa-solid fa-wand-magic-sparkles'></i>">	
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('Midjourney Turbo')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->midjourney_turbo); ?> <?php if($credits->midjourney_turbo == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>										
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
								<?php if(App\Services\HelperService::extensionClipdrop()): ?>
									<?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(trim($vendor) == 'clipdrop'): ?>																				
											<a class="dropdown-item pt-4 pb-4 d-flex" href="#"  id="clipdrop" name="<?php echo e(__('Clipdrop')); ?>" icon="<i class='   fa-solid fa-high-definition'></i>">						
												<h6 class="dropdown-item-title fs-12"><?php echo e(__('Clipdrop')); ?> <span class="fs-9 text-muted">(<?php echo e($credits->clipdrop); ?> <?php if($credits->clipdrop == 1): ?> <?php echo e(__('credit')); ?><?php else: ?><?php echo e(__('credits')); ?><?php endif; ?>)</span></h6>										
											</a>										
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php endif; ?>
			...
			<div id="form-group" class="mb-4">
				...
				<button class="btn form-control style-button-img-placeholder" type="button" id="style-button">
					<img src="<?php echo e(theme_url('img/frontend/thumbs/none.jpg')); ?>" class="style-button-img" id="style-button-img" alt=""><span><?php echo e(__('None')); ?></span>
							...
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/none.jpg')); ?>" width="90" height="80">
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/abstract.jpg')); ?>" id="style-abstract-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/realism.jpg')); ?>" id="style-realism-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/3d_model.webp')); ?>" id="style-3d-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/cartoon.jpg')); ?>" id="style-cartoon-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/anime.webp')); ?>"  id="style-anime-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/digitalart.jpg')); ?>" id="style-digital-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/artdeco.jpg')); ?>" id="style-artdeco-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/pixelart.jpg')); ?>" id="style-pixel-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/origami.webp')); ?>" id="style-origami-thumb"  width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/illustration.webp')); ?>" id="style-illustration-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/thumb-72.webp')); ?>" id="style-photography-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/retro.webp')); ?>" id="style-retro-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/sketch.webp')); ?>" id="style-pencil-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/vaporwave.jpg')); ?>" id="style-vaporwave-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/popart.jpg')); ?>" id="style-popart-thumb"  width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/sticker.webp')); ?>" id="style-sticker-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/minimalism.jpg')); ?>" id="style-minimalism-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/reneissance.webp')); ?>" id="style-renaissance-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/ink.webp')); ?>" id="style-ballpoint-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/cyberpunk.webp')); ?>" id="style-cyberpunk-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/isometric.jpg')); ?>" id="style-isometric-thumb"width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/bauhaust.webp')); ?>" id="style-bauhaus-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/glitchcore.jpg')); ?>" id="style-glitchcore-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/steampunk.webp')); ?>" id="style-steampunk-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/ukiyo.webp')); ?>" id="style-ukiyo-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/lowpoly.jpg')); ?>" id="style-lowpoly-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/vector.png')); ?>" id="style-vector-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/imressionism.jpg')); ?>" id="style-impressionism-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4 openai-feature">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/cubism.webp')); ?>" id="style-cubism-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/cinematic.jpg')); ?>" id="style-cinematic-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/analog-film.jpg')); ?>" id="style-analog-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/fantasy-art.jpeg')); ?>" id="style-fantasy-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
						...
						<div class="col-md-4">
							<div class="image-style">
								<label class="mb-0">
									...
									<div for="style-none" class="image-label">
										<img src="<?php echo e(theme_url('img/frontend/thumbs/line-art.jpg')); ?>" id="style-line-thumb" width="90" height="80">
										<div class="bg-dark-overlay"></div>
...
<script type="text/javascript">
	let task = 'none';
	let active_model = '<?php echo e($model); ?>';
	let vendor = '<?php echo e($vendor); ?>';
	...
	$(function () {
		...
		$('#openai-form').on('submit', function(e) {
			...
			$.ajax({
				...
				cache: false,
				beforeSend: function() {
					$('#image-generate').html('<i class="   fa-solid fa-wand-magic-sparkles fa-beat-fade mr-2"></i><?php echo e(__("Generating...")); ?>');
					$('#image-generate').prop('disabled', true);       
				},
				complete: function() {
					$('#image-generate').prop('disabled', false);
					$('#image-generate').html('<i class="   fa-solid fa-wand-magic-sparkles mr-2"></i><?php echo e(__("Generate")); ?>');            
				},
				success: function (data) {		
	...
	function setResolution() {
		...
		if (active_model == 'dall-e-2') {	
			...
			$('#resolution').append("<option value='1:1'>1:1 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='2:3'>2:3 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='3:2'>3:2 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='4:5'>4:5 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='5:4'>5:4 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='9:16'>9:16 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='16:9'>16:9 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='9:21'>9:21 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			vendor = 'sd';
			sdReset();
		} else if (active_model == 'flux-realism' || active_model == 'flux-pro/new' || active_model == 'flux/schnell' || active_model == 'flux/dev') {
			$('#resolution').append("<option value='square_hd'><?php echo e(__('Square HD')); ?></option>");
			$('#resolution').append("<option value='square'><?php echo e(__('Square')); ?></option>");
			$('#resolution').append("<option value='portrait_4_3'><?php echo e(__('Portrait 4:3')); ?></option>");
			$('#resolution').append("<option value='portrait_16_9'><?php echo e(__('Portrait 16:9')); ?></option>");
			$('#resolution').append("<option value='landscape_4_3'><?php echo e(__('Landscape 4:3')); ?></option>");
			$('#resolution').append("<option value='landscape_16_9'><?php echo e(__('Landscape 16:9')); ?></option>");
			vendor = 'falai';
			falaiReset();
			...
			$('#resolution').append("<option value='4:5'>4:5 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='5:4'>5:4 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='7:4'>7:4 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='9:16'>9:16 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			$('#resolution').append("<option value='16:9'>16:9 (<?php echo e(__('Aspect Ratio')); ?>)</option>");
			vendor = 'midjourney';
			falaiReset();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/default/user/images/index.blade.php ENDPATH**/ ?>