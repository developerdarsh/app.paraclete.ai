...
class OpenRouter
{
    ...
    public function processStream($callback)
    {
        try {
            ...
            $model_id = $this->openRouterModels($chat_message->model); 

            // Initialize OpenRouter client
            $client = new Client([
                'base_uri' => 'https://openrouter.ai/api/v1/',
                'headers' => [
                    'Authorization' => 'Bearer ' . $extension->open_router_key,
            ...
            while (!$stream->eof()) {
                ...
                foreach ($chunks as $chunk) {
                    ...
                    try {
                        ...
                        Log::error('OpenRouter JSON decode error: ' . $e->getMessage());
                        continue;
                    }
                }
            }
            ...
            $callback('OpenRouter API Notification: <span class="font-weight-bold">An error occurred while processing your request. Please try again later.</span>');
            $callback('[DONE]');
        }
    }
    ...
    public function processTemplateStream($callback)
    {
        try {
            ...
            $extension = ExtensionSetting::first();
            $model_id = $this->openRouterModels($content->model); 
    ...
    private function openRouterModels($model)
    {
        switch($model) {
            case 'gpt-3.5-turbo-0125': return 'openai/gpt-3.5-turbo-0613'; break;
            case 'gpt-4': return 'openai/gpt-4'; break;
            case 'gpt-4o': return 'openai/gpt-4o'; break;
            case 'gpt-4o-mini': return 'openai/gpt-4o-mini'; break;
            case 'gpt-4-0125-preview': return 'openai/gpt-4-turbo-preview'; break;
            case 'gpt-4.5-preview': return 'openai/gpt-4.5-preview'; break;
            case 'o1': return 'openai/o1'; break;
            case 'o1-mini': return 'openai/o1-mini'; break;
            case 'o3-mini': return 'openai/o3-mini'; break;
            case '': return 'openai/'; break;
            default: return 'openai/gpt-4o'; break;
        }
    }
