...
{   
    ...
    public function create()
    {
        ...
        return view('admin.finance.plans.finance_subscription_create', compact('models', 'prices'));
    }
    ...
    public function edit(SubscriptionPlan $id)
    {
        ...
        $images = explode(',', $id->image_vendors);

        $prices = VendorPrice::first();

        return view('admin.finance.plans.finance_subscription_edit', compact('id', 'models', 'vendors', 'model_templates', 'model_chats', 'prices', 'images'));
    }
